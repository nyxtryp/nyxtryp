...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Jo(e,t,n){let r=new Float32Array(Po),i=new W(0,1,0);return new oa({name:`SphericalGaussianBlur`,defines:{n:Po,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Zo(),fragmentShader:`
	...
	`}var Qo=class extends fn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Hi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `}),n=new mi(new Xi(e.radius*1.075,128,128),t);o.add(n)}if(e.atmosphere){let t=new Un;t.name=`AUDIO_MENU_SATELLITES_V1`,o.add(t);let n=new Un;n.name=`TRACKS`;let r=new mi(new Xi(e.radius*.2,32,32),new ca({color:1381146,metalness:.72,roughness:.28,emissive:2365195,emissiveIntensity:.45}));n.add(r);let i=new mi(new Xi(e.radius*.42,16,16),new ni({transparent:!0,opacity:0,depthWrite:!1}));i.userData.isTracksHitArea=!0,n.add(i);let a=new mi(new Zi(e.radius*.3,e.radius*.018,12,64),new ni({color:16761917,transparent:!0,opacity:.95}));a.rotation.x=Math.PI*.48,n.add(a);for(let t=0;t<4;t++){let r=new mi(new Ki(e.radius*.3,e.radius*.014,e.radius*.018),new ni({color:16767078,transparent:!0,opacity:.8}));r.position.set(-e.radius*.05,(t-1.5)*e.radius*.065,e.radius*.2),r.rotation.z=(t-1.5)*.07,n.add(r)}n.position.set(-e.radius*2,0,0),t.add(n);let s=new Un;s.name=`MIXES`;let c=new mi(new Xi(e.radius*.22,32,32),new ca({color:7421388,metalness:.55,roughness:.24,emissive:3412062,emissiveIntensity:.8}));s.add(c);let l=new ni({color:13671167,transparent:!0,opacity:.9}),u=new ni({color:9395455,transparent:!0,opacity:.8}),d=new mi(new Zi(e.radius*.34,e.radius*.015,12,64),l);d.rotation.x=Math.PI*.42,d.rotation.z=Math.PI*.18,s.add(d);let f=new mi(new Zi(e.radius*.34,e.radius*.013,12,64),u);f.rotation.x=-Math.PI*.42,f.rotation.z=-Math.PI*.22,s.add(f);for(let t=0;t<3;t++){let n=new mi(new Xi(e.radius*.035,16,16),new ni({color:15187455})),r=t*Math.PI*2/3;n.position.set(Math.cos(r)*e.radius*.4,Math.sin(r)*e.radius*.25,Math.sin(r)*e.radius*.4),s.add(n)}s.position.set(e.radius*2,.15,0),t.add(s);let p=new Un;p.name=`RADIO`;let m=new mi(new Xi(e.radius*.21,32,32),new ca({color:2330328,metalness:.48,roughness:.22,emissive:411765,emissiveIntensity:.8}));p.add(m);let h=new mi(new Xi(e.radius*.55,16,16),new ni({transparent:!0,opacity:0,depthWrite:!1}));h.name=`RADIO_HITBOX`,p.add(h);let g=new mi(new qi(e.radius*.014,e.radius*.022,e.radius*.45,12),new ca({color:12115967,metalness:.8,roughness:.18}));g.position.y=e.radius*.32,p.add(g);let _=new mi(new Xi(e.radius*.17,24,12,0,Math.PI*2,0,Math.PI*.5),new ca({color:10214655,metalness:.72,roughness:.18,emissive:1204368,emissiveIntensity:.55,side:2}));_.position.y=e.radius*.54,_.rotation.x=-Math.PI*.25,p.add(_);let v=new ni({color:5626367,transparent:!0,opacity:.48});for(let t=0;t<3;t++){let n=new mi(new Zi(e.radius*(.28+t*.12),e.radius*.012,8,48,Math.PI),v);n.position.set(e.radius*(.16+t*.04),e.radius*(.68+t*.06),0),n.rotation.z=-Math.PI*.5,p.add(n)}p.position.set(0,e.radius*2,-e.radius*.1),t.add(p),t.userData.menuPositions={TRACKS:new W(-e.radius*2,0,0),MIXES:new W(0,e.radius*2,0),RADIO:new W(e.radius*2,0,0)},t.userData.menuRotations={TRACKS:new Tn(0,0,0),MIXES:new Tn(0,0,0),RADIO:new Tn(0,0,0)},t.userData.freePositions={TRACKS:n.position.clone(),MIXES:s.position.clone(),RADIO:p.position.clone()},o.userData.audioSatellites=t}let l={mesh:o,speed:e.speed,base:o.position.clone(),driftX:.1+Math.random()*.16,driftY:.08+Math.random()*.14,driftZ:.06+Math.random()*.12,ampX:.35+Math.random()*.35,ampY:.25+Math.random()*.3,ampZ:.2+Math.random()*.3,phaseX:Math.random()*Math.PI*2,phaseY:Math.random()*Math.PI*2,phaseZ:Math.random()*Math.PI*2,selectionOffset:new W};b.push(l);let u=document.createElement(`div`);if(u.className=`planet-name`,u.textContent=e.name,u.style.position=`absolute`,u.style.color=`#ffffff`,u.style.fontSize=`8px`,u.style.letterSpacing=`0.28em`,u.style.fontFamily=`Arial, Helvetica, sans-serif`,u.style.pointerEvents=`none`,u.style.whiteSpace=`nowrap`,u.style.transform=`translate(-50%, -50%)`,u.style.opacity=`0.8`,u.style.zIndex=`20`,i.appendChild(u),l.nameLabel=u,e.rings){let t=y.load(`/textures/planets/saturn-ring.png`);t.colorSpace=tt;let n=new mi(new Yi(e.radius*1.25,e.radius*2.05,96),new ca({map:t,transparent:!0,side:2,depthWrite:!1,roughness:.85}));n.rotation.x=Math.PI/2.25,n.rotation.z=.15,o.add(n)}});let x={};[`TRACKS`,`MIXES`,`RADIO`].forEach(e=>{let t=document.createElement(`div`);t.style.position=`absolute`,t.style.left=`0`,t.style.top=`0`,t.style.transform=`translate(-50%, -50%)`,t.style.color=`#ffffff`,t.style.fontSize=`9px`,t.style.fontFamily=`Arial, Helvetica, sans-serif`,t.style.fontWeight=`400`,t.style.letterSpacing=`0.32em`,t.style.textTransform=`uppercase`,t.style.whiteSpace=`nowrap`,t.style.pointerEvents=`none`,t.style.opacity=`0`,t.style.transition=`opacity 0.25s ease`,t.style.zIndex=`21`,t.textContent=e,i.appendChild(t),x[e]=t});let S=new ho,C=new U,w=null,T=null,E=!1,D=!1,O=0,k=0,A=17,ee=new W(0,0,17),te=new W(0,0,0),ne=e=>{let t=l.getBoundingClientRect();C.x=(e.clientX-t.left)/t.width*2-1,C.y=-((e.clientY-t.top)/t.height*2-1)},re=e=>{ne(e),S.setFromCamera(C,s);let t=b.map(({mesh:e})=>e),n=[];for(let{mesh:e}of b)e.userData.name===`AUDIO`&&e.userData.audioSatellites&&e.userData.audioSatellites.traverse(e=>{e.isMesh&&e.visible&&n.push(e)});let r=S.intersectObjects(t,!1),i=S.intersectObjects(n,!1);return i.length?i[0].object:r.length?r[0].object:null},ie=!1,j=!1,M=e=>{let t=re(e);if(t&&!D?(w=t,l.style.cursor=`pointer`):D||(w=null,l.style.cursor=`default`),!D)return;let n=e.clientX-O,r=e.clientY-k;(Math.abs(n)>2||Math.abs(r)>2)&&(ie=!0),O=e.clientX,k=e.clientY,T&&(T.rotation.y+=n*.01,T.rotation.x+=r*.005,T.rotation.x=Wt.clamp(T.rotation.x,-Math.PI*.45,Math.PI*.45))},ae=r=>{if(r.pointerType===`mouse`&&r.button!==0)return;let i=re(r);if(!i){D=!1;return}let a=null,o=i;for(;o;){if(o.name===`RADIO`){a=o;break}o=o.parent}if(a){E&&T&&T.userData.name===`AUDIO`&&e&&e(),D=!1,ie=!1,j=!1;return}let s=null;for(o=i;o;){if(o.name===`TRACKS`){s=o;break}o=o.parent}if(s){E&&T&&T.userData.name===`AUDIO`&&n&&n(),D=!1,ie=!1,j=!1;return}let c=null;for(o=i;o;){if(o.name===`MIXES`){c=o;break}o=o.parent}if(c){E&&T&&T.userData.name===`AUDIO`&&t&&t(),D=!1,ie=!1,j=!1;return}if(T===i){j=!0,ie=!1,D=!0,O=r.clientX,k=r.clientY,l.style.cursor=`grabbing`;return}j=!1,ie=!1,T=i,E=i.userData.name===`AUDIO`,A=Wt.clamp(i.geometry.parameters.radius*7,4.5,8),D=!0,O=r.clientX,k=r.clientY,l.style.cursor=`grabbing`},oe=()=>{D=!1,j&&!ie&&(T=null,E=!1,A=17),j=!1,ie=!1,w?l.style.cursor=`pointer`:l.style.cursor=`default`},se=e=>{e.preventDefault(),T&&(A+=e.deltaY*.012,A=Wt.clamp(A,Math.max(1.8,T.geometry.parameters.radius*2.2),17))};l.addEventListener(`pointermove`,M),l.addEventListener(`pointerdown`,ae),l.addEventListener(`pointerup`,oe),l.addEventListener(`pointercancel`,oe),l.addEventListener(`wheel`,se,{passive:!1});let N,ce=()=>{let e=performance.now()*.001;b.forEach(t=>{let{mesh:n,speed:r,base:i,driftX:a,driftY:o,driftZ:c,ampX:u,ampY:d,ampZ:f,phaseX:p,phaseY:m,phaseZ:h}=t;if(t.nameLabel){let e=new W;n.getWorldPosition(e),e.y+=n.geometry.parameters.radius*1.6,e.project(s);let r=l.getBoundingClientRect();t.nameLabel.style.left=(e.x+1)/2*r.width+`px`,t.nameLabel.style.top=(-e.y+1)/2*r.height+`px`;let i=n.position.clone().sub(s.position).normalize(),a=new ho(s.position,i),o=b.filter(e=>e.mesh!==n).map(e=>e.mesh),c=a.intersectObjects(o,!1);t.nameLabel.style.opacity=c.length?`0`:`0.8`}n!==T&&(n.rotation.y+=r);let g=n.userData.audioSatellites;if(g){let e=g.userData.menuPositions,t=g.userData.freePositions;if(e&&t){let r=E&&n===T,i=n.quaternion.clone().invert(),a={TRACKS:e.TRACKS.clone(),MIXES:e.MIXES.clone(),RADIO:e.RADIO.clone()},o={TRACKS:a.TRACKS.applyQuaternion(i),MIXES:a.MIXES.applyQuaternion(i),RADIO:a.RADIO.applyQuaternion(i)},s={TRACKS:r?o.TRACKS:t.TRACKS,MIXES:r?o.MIXES:t.MIXES,RADIO:r?o.RADIO:t.RADIO},c=g.userData.menuRotations,l=g.getObjectByName(`TRACKS`),u=g.getObjectByName(`MIXES`),d=g.getObjectByName(`RADIO`);l&&(l.position.lerp(s.TRACKS,.08),r&&l.quaternion.slerp(new Gt().setFromEuler(c.TRACKS).premultiply(i),.08)),u&&(u.position.lerp(s.MIXES,.08),r&&u.quaternion.slerp(new Gt().setFromEuler(c.MIXES).premultiply(i),.08)),d&&(d.position.lerp(s.RADIO,.08),r&&d.quaternion.slerp(new Gt().setFromEuler(c.RADIO).premultiply(i),.08))}}let _=i.x+Math.sin(e*a+p)*u,v=i.y+Math.sin(e*o+m)*d,y=i.z+Math.sin(e*c+h)*f,x=new W(0,0,s.position.z-A),S=new W(_,v,y),C=n===T?x.sub(S):new W;t.selectionOffset.lerp(C,.045),n.position.set(_+t.selectionOffset.x,v+t.selectionOffset.y,y+t.selectionOffset.z)}),ee.lerp(new W(0,0,window.innerWidth<768?28:17),.05),te.lerp(new W(0,0,0),.05),s.position.copy(ee),s.lookAt(te),[`TRACKS`,`MIXES`,`RADIO`].forEach(e=>{let t=x[e];if(!t)return;let n=(T?.userData?.audioSatellites)?.getObjectByName(e);if(E&&n){let e=n.getWorldPosition(new W);e.y+=T.geometry.parameters.radius*.48;let r=e.project(s),i=l.getBoundingClientRect();t.style.left=`${(r.x+1)*.5*i.width}px`,t.style.top=`${(-r.y+1)*.5*i.height}px`,t.style.opacity=`1`}else t.style.opacity=`0`}),g.forEach(({object:e,speed:t},n)=>{e.rotation.y+=t*(n+1),e.rotation.x+=t*.35});let t=1+Math.sin(e*.45)*.025;m.scale.setScalar(t),h.scale.setScalar(1+Math.sin(e*.45)*.05),v.forEach(e=>{e.active?(e.life+=.016,e.object.position.x-=.22,e.object.position.y-=.08,e.object.material.opacity=Math.max(0,1-e.life/.8),e.life>.8&&(e.active=!1,e.timer=8+Math.random()*18)):(e.timer-=.016,e.timer<=0&&(e.active=!0,e.life=0,e.object.position.set((Math.random()-.5)*24,6+Math.random()*8,-10-Math.random()*30),e.object.material.opacity=1))}),c.render(a,s),N=requestAnimationFrame(ce)},P=()=>{let e=i.clientWidth,t=i.clientHeight;s.aspect=e/t,s.updateProjectionMatrix(),c.setSize(e,t)};return P(),window.addEventListener(`resize`,P),ce(),()=>{cancelAnimationFrame(N),window.removeEventListener(`resize`,P),l.removeEventListener(`pointermove`,M),l.removeEventListener(`pointerdown`,ae),l.removeEventListener(`pointerup`,oe),l.removeEventListener(`pointercancel`,oe),l.removeEventListener(`wheel`,se),b.forEach(({mesh:e})=>{e.geometry.dispose(),e.material.map?.dispose(),e.material.dispose()}),g.forEach(({object:e})=>{e.geometry.dispose(),e.material.dispose()}),v.forEach(({object:e})=>{e.geometry.dispose(),e.material.dispose()}),Object.values(x).forEach(e=>{e.remove()}),document.querySelectorAll(`.planet-name`).forEach(e=>{e.remove()}),c.dispose(),i.contains(c.domElement)&&i.removeChild(c.domElement)}},[]),(0,$.jsx)(`div`,{ref:r,className:`planet-field`})}var zl=[{title:`Amazing Nature`,file:`/audio/radio/Amazing_Nature.mp3`},{title:`Calm Vibrations`,file:`/audio/radio/Calm_Vibrations.mp3`},{title:`Deep Sleep`,file:`/audio/radio/Deep_Sleep.mp3`},{title:`Forest Before Rain`,file:`/audio/radio/Forest_Before_Rain.mp3`},{title:`Forest Sounds`,file:`/audio/radio/Forest_Sounds.mp3`},{title:`Harmony`,file:`/audio/radio/Harmony.mp3`},{title:`Inner Peace`,file:`/audio/radio/Inner_Peace.mp3`},{title:`Inside Japan`,file:`/audio/radio/Inside_Japan.mp3`},{title:`Iren Lullaby`,file:`/audio/radio/Iren_Lullaby.mp3`},{title:`Morning Prayer`,file:`/audio/radio/Morning_Prayer.mp3`},{title:`Ocean Waves`,file:`/audio/radio/Ocean_Waves.mp3`},{title:`Path to Happiness`,file:`/audio/radio/Path_to_Happiness.mp3`},{title:`Quiet Place`,file:`/audio/radio/Quiet_Place.mp3`},{title:`Sparks`,file:`/audio/radio/Sparks.mp3`},{title:`Thunderstorm`,file:`/audio/radio/Thunderstorm.mp3`}];function Bl(e=-1){if(zl.length<=1)return 0;let t=Math.floor(Math.random()*zl.length);for(;t===e;)t=Math.floor(Math.random()*zl.length);return t}function Vl({onClose:e}){if(!document.getElementById(`lori-animation`)){let e=document.createElement(`style`);e.id=`lori-animation`,e.innerHTML=`
      @keyframes loriPulse {
        0%,100% {
          opacity: .45;
    ...
    `,document.head.appendChild(e)}let t=(0,_.useRef)(null),n=(0,_.useRef)(null),r=(0,_.useRef)(null),i=(0,_.useRef)(null),a=(0,_.useRef)(null),o=(0,_.useRef)(null),[s,c]=(0,_.useState)(!1),[l,u]=(0,_.useState)(!1),[d,f]=(0,_.useState)(.68),[p,m]=(0,_.useState)(()=>Bl()),[h,g]=(0,_.useState)(92),[v,y]=(0,_.useState)(`1.4s`),b=zl[p],x=()=>{let e=t.current;if(!e)return null;if(r.current)return r.current;let n=window.AudioContext||window.webkitAudioContext;if(!n)return null;let o=new n,s=o.createAnalyser();s.fftSize=2048,s.smoothingTimeConstant=.78;let c=o.createMediaElementSource(e);return c.connect(s),s.connect(o.destination),r.current=o,i.current=s,a.current=c,o};return(0,_.useEffect)(()=>{let e=n.current,t=i.current;if(!e||!t)return;let a=e.getContext(`2d`),c=new Uint8Array(t.frequencyBinCount),l=Array(64).fill(0),u=()=>{let n=e.width,i=e.height;a.clearRect(0,0,n,i),t.getByteFrequencyData(c);let d=25e3,f=(r.current?.sampleRate||44100)/t.fftSize,p=(n-126)/64;for(let e=0;e<64;e++){let t=16*(d/16)**(e/64),n=16*(d/16)**((e+1)/64),r=Math.floor(t/f),o=Math.max(r+1,Math.floor(n/f)),u=0,m=0;for(let e=r;e<o&&e<c.length;e++)u+=c[e],m++;let h=u/Math.max(m,1)/255;h=Math.min(h,.85)**2.4,h*=1,l[e]+=((s?h:.05)-l[e])*.08;let g=i*(l[e]/(l[e]+.45))*.95,_=e*(p+2),v=i-g,y=a.createLinearGradient(0,v,0,i);y.addColorStop(0,`rgba(130,220,255,0.95)`),y.addColorStop(1,`rgba(80,130,255,0.15)`),a.fillStyle=y,a.fillRect(_,v,p,g)}o.current=requestAnimationFrame(u)};return u(),()=>{o.current&&cancelAnimationFrame(o.current)}},[s]),(0,_.useEffect)(()=>{let e=t.current;e&&(e.volume=d,e.muted=l)},[d,l]),(0,_.useEffect)(()=>{let e=setInterval(()=>{g(88+Math.floor(Math.random()*10));let e=(1.1+Math.random()*1).toFixed(1);y(`${e}s`)},1800);return()=>clearInterval(e)},[]),(0,_.useEffect)(()=>{let e=t.current;e&&(e.src=b.file,e.load(),(async()=>{try{let t=x();t&&t.state===`suspended`&&await t.resume(),await e.play(),c(!0)}catch{c(!1)}})())},[p]),(0,$.jsxs)(`div`,{style:{width:`min(420px, 90vw)`,padding:`46px 26px 22px`,borderRadius:`24px`,background:`linear-gradient(145deg, rgba(9,15,27,.94), rgba(3,7,15,.97))`,border:`1px solid rgba(125,190,255,.20)`,boxShadow:`0 20px 70px rgba(0,0,0,.55), inset 0 0 40px rgba(70,150,255,.035)`,color:`#eaf4ff`,fontFamily:`Inter, system-ui, sans-serif`,backdropFilter:`blur(18px)`,position:`relative`},children:[(0,$.jsx)(`audio`,{ref:t,onEnded:()=>{m(e=>Bl(e))}}),(0,$.jsx)(`button`,{onClick:e,"aria-label":`Close radio`,style:{position:`absolute`,top:14,right:16,zIndex:5,border:`none`,background:`transparent`,color:`rgba(220,240,255,.62)`,fontSize:22,fontWeight:300,lineHeight:1,cursor:`pointer`,padding:`4px 7px`},children:`×`}),(0,$.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,alignItems:`flex-start`,marginBottom:22},children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`div`,{style:{fontSize:11,letterSpacing:`3px`,opacity:.55,marginBottom:7},children:`NYXTRYP`}),(0,$.jsxs)(`div`,{style:{fontSize:21,letterSpacing:`4px`,fontWeight:500,display:`flex`,gap:`4px`},children:[(0,$.jsx)(`span`,{children:`Radio\xA0`}),`LORI`.split(``).map((e,t)=>(0,$.jsx)(`span`,{style:{animation:`loriPulse ${1.6+t*.3}s ease-in-out infinite`,animationDelay:`${t*.35}s`},children:e},t))]}),(0,$.jsx)(`div`,{style:{marginTop:7,fontSize:9,letterSpacing:`2px`,opacity:.42},children:`RELAXATION · AMBIENT · CONTINUOUS`})]}),(0,$.jsxs)(`div`,{style:{textAlign:`right`,fontSize:9,letterSpacing:`1.5px`},children:[(0,$.jsx)(`div`,{style:{color:`#75d8ff`,marginBottom:6},children:`● SIGNAL LINK`}),(0,$.jsx)(`div`,{style:{opacity:.5},children:`EARTH RELAY`})]})]}),(0,$.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:8,marginBottom:18},children:[Array.from({length:12}).map((e,t)=>{let n=t<Math.round(h/8);return(0,$.jsx)(`div`,{style:{width:5,height:7+t*1.4,borderRadius:2,background:n?`#70d8ff`:`rgba(120,180,220,.12)`,boxShadow:n?`0 0 8px rgba(90,210,255,.5)`:`none`}},t)}),(0,$.jsxs)(`div`,{style:{marginLeft:`auto`,fontSize:9,letterSpacing:`1px`,opacity:.55},children:[h,`% · `,v]})]}),(0,$.jsx)(`div`,{style:{height:105,borderRadius:14,overflow:`hidden`,padding:`0 22px`,background:`rgba(0,0,0,.20)`,border:`1px solid rgba(100,180,255,.08)`,marginBottom:18},children:(0,$.jsx)(`canvas`,{ref:n,width:720,height:210,style:{width:`100%`,height:`100%`,display:`block`}})}),(0,$.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:12,marginBottom:16},children:[(0,$.jsx)(`button`,{onClick:async()=>{let e=t.current;if(e){if(s){e.pause(),c(!1);return}try{let t=x();t&&t.state===`suspended`&&await t.resume(),await e.play(),c(!0)}catch{c(!1)}}},style:{width:42,height:42,borderRadius:`50%`,border:`1px solid rgba(120,210,255,.28)`,background:`rgba(80,170,255,.08)`,color:`#dff7ff`,cursor:`pointer`,fontSize:16},children:s?`Ⅱ`:`▶`}),(0,$.jsxs)(`div`,{style:{flex:1,minWidth:0},children:[(0,$.jsx)(`div`,{style:{fontSize:10,letterSpacing:`1.8px`,opacity:.42,marginBottom:5},children:`NOW TRANSMITTING`}),(0,$.jsx)(`div`,{style:{fontSize:13,letterSpacing:`1px`,whiteSpace:`nowrap`,overflow:`hidden`,textOverflow:`ellipsis`},children:b.title})]})]}),(0,$.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:10},children:[(0,$.jsx)(`button`,{onClick:()=>u(e=>!e),style:{border:`none`,background:`transparent`,color:`rgba(220,240,255,.7)`,cursor:`pointer`,fontSize:16},children:l?`🔇`:`🔊`}),(0,$.jsx)(`input`,{type:`range`,min:`0`,max:`1`,step:`0.01`,value:d,onChange:e=>f(Number(e.target.value)),style:{flex:1,accentColor:`#73d8ff`}}),(0,$.jsx)(`span`,{style:{fontSize:9,opacity:.42,minWidth:28,textAlign:`right`},children:Math.round(d*100)})]})]})}var Hl=[{title:`Divine Artist - Best of Ethnic`,file:`/audio/mixes/Divine Artist - Best of Ethnic.mp3`},{title:`Midnight in Cairo Arabic Jazz & Oud Melodies for Late Night Reflection`,file:`/audio/mixes/Midnight in Cairo Arabic Jazz & Oud Melodies for Late Night Reflection.mp3`},{title:`Moon Over Arabia Desert Media`,file:`/audio/mixes/Moon Over Arabia Desert Media.mp3`},{title:`TRANCE FESTIVAL 2026 🔥 🎶 Best of .mp3`,file:`/audio/mixes/TRANCE FESTIVAL 2026 🔥 🎶 Best of .mp3`}];function Ul(e){if(!Number.isFinite(e)||e<0)return`0:00`;let t=Math.floor(e/60),n=Math.floor(e%60);return`${t}:${String(n).padStart(2,`0`)}`}function Wl({onClose:e}){let t=(0,_.useRef)(null),n=(0,_.useRef)(null),r=(0,_.useRef)(null),i=(0,_.useRef)(null),a=(0,_.useRef)(null),o=(0,_.useRef)(null),[s,c]=(0,_.useState)(!1),[l,u]=(0,_.useState)(!1),[d,f]=(0,_.useState)(.68),[p,m]=(0,_.useState)(0),[h,g]=(0,_.useState)(0),[v,y]=(0,_.useState)(0),[b,x]=(0,_.useState)(92),[S,C]=(0,_.useState)(`1.4s`),w=Hl[p];(0,_.useEffect)(()=>{if(document.getElementById(`mixes-animation`))return;let e=document.createElement(`style`);return e.id=`mixes-animation`,e.innerHTML=`
    ...
    `,document.head.appendChild(e),()=>{e.remove()}},[]);let T=()=>{let e=t.current;if(!e)return null;if(r.current)return r.current;let n=window.AudioContext||window.webkitAudioContext;if(!n)return null;let o=new n,s=o.createAnalyser();s.fftSize=2048,s.smoothingTimeConstant=.78;let c=o.createMediaElementSource(e);return c.connect(s),s.connect(o.destination),r.current=o,i.current=s,a.current=c,o};(0,_.useEffect)(()=>{let e=n.current,t=i.current;if(!e||!t)return;let a=e.getContext(`2d`),c=new Uint8Array(t.frequencyBinCount),l=Array(64).fill(0),u=()=>{let n=e.width,i=e.height;a.clearRect(0,0,n,i),t.getByteFrequencyData(c);let d=25e3,f=(r.current?.sampleRate||44100)/t.fftSize,p=(n-126)/64;for(let e=0;e<64;e++){let t=16*(d/16)**(e/64),n=16*(d/16)**((e+1)/64),r=Math.floor(t/f),o=Math.max(r+1,Math.floor(n/f)),u=0,m=0;for(let e=r;e<o&&e<c.length;e++)u+=c[e],m++;let h=u/Math.max(m,1)/255;h=Math.min(h,.85)**2.4,l[e]+=((s?h:.05)-l[e])*.08;let g=i*(l[e]/(l[e]+.45))*.95,_=e*(p+2),v=i-g,y=a.createLinearGradient(0,v,0,i);y.addColorStop(0,`rgba(130,220,255,0.95)`),y.addColorStop(1,`rgba(80,130,255,0.15)`),a.fillStyle=y,a.fillRect(_,v,p,g)}o.current=requestAnimationFrame(u)};return u(),()=>{o.current&&cancelAnimationFrame(o.current)}},[s]),(0,_.useEffect)(()=>{let e=t.current;e&&(e.volume=d,e.muted=l)},[d,l]),(0,_.useEffect)(()=>{let e=t.current;if(!e)return;let n=()=>{g(e.currentTime||0)},r=()=>{Number.isFinite(e.duration)&&y(e.duration)};return e.addEventListener(`timeupdate`,n),e.addEventListener(`loadedmetadata`,r),e.addEventListener(`durationchange`,r),()=>{e.removeEventListener(`timeupdate`,n),e.removeEventListener(`loadedmetadata`,r),e.removeEventListener(`durationchange`,r)}},[p]),(0,_.useEffect)(()=>{let e=setInterval(()=>{x(88+Math.floor(Math.random()*10));let e=(1.1+Math.random()*1).toFixed(1);C(`${e}s`)},1800);return()=>clearInterval(e)},[]),(0,_.useEffect)(()=>{let e=t.current;e&&(e.src=w.file,e.load(),g(0),y(0),(async()=>{try{let t=T();t&&t.state===`suspended`&&await t.resume(),await e.play(),c(!0)}catch{c(!1)}})())},[p]);let E=()=>{m(e=>(e+1)%Hl.length)},D=async()=>{let e=t.current;if(e){if(s){e.pause(),c(!1);return}try{let t=T();t&&t.state===`suspended`&&await t.resume(),await e.play(),c(!0)}catch{c(!1)}}},O=e=>{let n=t.current;if(!n||!v)return;let r=Number(e.target.value);n.currentTime=r,g(r)},k=e=>{m(t=>e<0?(t-1+Hl.length)%Hl.length:(t+1)%Hl.length)};return(0,$.jsxs)(`div`,{style:{width:`min(420px, 90vw)`,padding:`46px 26px 22px`,borderRadius:`24px`,background:`linear-gradient(145deg, rgba(9,15,27,.94), rgba(3,7,15,.97))`,border:`1px solid rgba(125,190,255,.20)`,boxShadow:`0 20px 70px rgba(0,0,0,.55), inset 0 0 40px rgba(70,150,255,.035)`,color:`#eaf4ff`,fontFamily:`Inter, system-ui, sans-serif`,backdropFilter:`blur(18px)`,position:`relative`},children:[(0,$.jsx)(`audio`,{ref:t,onEnded:E}),(0,$.jsx)(`button`,{onClick:e,"aria-label":`Close mixes`,style:{position:`absolute`,top:14,right:16,zIndex:5,border:`none`,background:`transparent`,color:`rgba(220,240,255,.62)`,fontSize:22,fontWeight:300,lineHeight:1,cursor:`pointer`,padding:`4px 7px`},children:`×`}),(0,$.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,alignItems:`flex-start`,marginBottom:22},children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`div`,{style:{fontSize:11,letterSpacing:`3px`,opacity:.55,marginBottom:7},children:`NYXTRYP`}),(0,$.jsx)(`div`,{style:{fontSize:21,letterSpacing:`4px`,fontWeight:500},children:`MIXES`.split(``).map((e,t)=>(0,$.jsx)(`span`,{style:{animation:`loriPulse ${1.6+t*.3}s ease-in-out infinite`,animationDelay:`${t*.35}s`},children:e},t))})]}),(0,$.jsxs)(`div`,{style:{textAlign:`right`,fontSize:9,letterSpacing:`1.5px`},children:[(0,$.jsx)(`div`,{style:{color:`#75d8ff`,marginBottom:6},children:`● MIX LINK`}),(0,$.jsx)(`div`,{style:{opacity:.5},children:`AUDIO RELAY`})]})]}),(0,$.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:8,marginBottom:18},children:[Array.from({length:12}).map((e,t)=>{let n=t<Math.round(b/8);return(0,$.jsx)(`div`,{style:{width:5,height:7+t*1.4,borderRadius:2,background:n?`#70d8ff`:`rgba(120,180,220,.12)`,boxShadow:n?`0 0 8px rgba(90,210,255,.5)`:`none`}},t)}),(0,$.jsxs)(`div`,{style:{marginLeft:`auto`,fontSize:9,letterSpacing:`1px`,opacity:.55},children:[b,`% · `,S]})]}),(0,$.jsx)(`div`,{style:{height:105,borderRadius:14,overflow:`hidden`,padding:`0 22px`,background:`rgba(0,0,0,.20)`,border:`1px solid rgba(100,180,255,.08)`,marginBottom:18},children:(0,$.jsx)(`canvas`,{ref:n,width:720,height:210,style:{width:`100%`,height:`100%`,display:`block`}})}),(0,$.jsx)(`div`,{style:{marginBottom:18},children:(0,$.jsx)(`div`,{style:{position:`relative`,overflow:`hidden`,width:`100%`,height:22,whiteSpace:`nowrap`},children:(0,$.jsx)(`div`,{style:{display:`inline-block`,whiteSpace:`nowrap`,animation:w.title.length>34?`mixTitleScroll 18s linear infinite`:`none`,paddingLeft:w.title.length>34?`100%`:0},children:w.title})})}),(0,$.jsxs)(`div`,{style:{marginBottom:18},children:[(0,$.jsx)(`input`,{type:`range`,min:`0`,max:v||0,step:`0.1`,value:Math.min(h,v||0),onChange:O,disabled:!v,style:{width:`100%`,accentColor:`#73d8ff`,cursor:v?`pointer`:`default`}}),(0,$.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,marginTop:5,fontSize:9,letterSpacing:`1px`,opacity:.42},children:[(0,$.jsx)(`span`,{children:Ul(h)}),(0,$.jsx)(`span`,{children:Ul(v)})]})]}),(0,$.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`center`,gap:12,marginBottom:16},children:[(0,$.jsx)(`button`,{onClick:()=>k(-1),"aria-label":`Previous mix`,style:{width:38,height:38,borderRadius:`50%`,border:`1px solid rgba(120,210,255,.20)`,background:`rgba(80,170,255,.06)`,color:`#dff7ff`,cursor:`pointer`,fontSize:15},children:`‹`}),(0,$.jsx)(`button`,{onClick:D,style:{width:42,height:42,borderRadius:`50%`,border:`1px solid rgba(120,210,255,.28)`,background:`rgba(80,170,255,.08)`,color:`#dff7ff`,cursor:`pointer`,fontSize:16},children:s?`Ⅱ`:`▶`}),(0,$.jsx)(`button`,{onClick:()=>k(1),"aria-label":`Next mix`,style:{width:38,height:38,borderRadius:`50%`,border:`1px solid rgba(120,210,255,.20)`,background:`rgba(80,170,255,.06)`,color:`#dff7ff`,cursor:`pointer`,fontSize:15},children:`›`})]}),(0,$.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:10},children:[(0,$.jsx)(`button`,{onClick:()=>u(e=>!e),style:{border:`none`,background:`transparent`,color:`rgba(220,240,255,.7)`,cursor:`pointer`,fontSize:16},children:l?`🔇`:`🔊`}),(0,$.jsx)(`input`,{type:`range`,min:`0`,max:`1`,step:`0.01`,value:d,onChange:e=>f(Number(e.target.value)),style:{flex:1,accentColor:`#73d8ff`}}),(0,$.jsx)(`span`,{style:{fontSize:9,opacity:.42,minWidth:28,textAlign:`right`},children:Math.round(d*100)})]})]})}var Gl=[`After Midnight`,`Awaken The Machine`,`Beyond Reality`,`Beyond The Signal`,`Crystal Memory`,`Digital Paradise`,`Echoes Of Tomorrow`,`Electric Dreams`,`Electric Soul`,`Final Horizon`,`Future Is Calling`,`Gravity Of Light`,`Hidden Dimension`,`Higher State`,`Infinite Desire`,`Infinite Motion`,`Into The Unknown`,`Lost In Frequency`,`Neon Awakening`,`Night Protocol`,`Parallel Hearts`,`Silent Velocity`,`Synthetic Emotion`,`The Last Transmission`,`Zero Gravity`].map(e=>({title:`${e} — Nyxtryp`,file:`/audio/tracks/${e} — Nyxtryp.mp3`})),Kl=(e,t,n)=>Math.max(t,Math.min(n,e)),ql=e=>!Number.isFinite(e)||e<0?`0:00`:`${Math.floor(e/60)}:${String(Math.floor(e%60)).padStart(2,`0`)}`;function Jl({channel:e,value:t}){let n=[[-30,-7.24],[-20,1.04],[-10,9.53],[-7,18.9],[-5,28.35],[-3,38.11],[-1,46.89],[0,52.23],[3,63.81],[5,76.4],[10,81.69]],r=(e=>{let t=Kl(e,-30,10);for(let e=1;e<n.length;e++){let[r,i]=n[e],[a,o]=n[e-1];if(t<=r){let e=(t-a)/(r-a);return o+(i-o)*e}}return n[n.length-1][1]})(t),i=e.toLowerCase();return(0,$.jsxs)(`svg`,{className:`nyx-meter-svg`,viewBox:`0 0 1080 600`,role:`img`,"aria-label":`${e} VU meter`,children:[(0,$.jsxs)(`defs`,{children:[(0,$.jsx)(`filter`,{id:`shadow-${i}`,children:(0,$.jsx)(`feDropShadow`,{dx:`3`,dy:`3`,stdDeviation:`8`,floodOpacity:`.5`})}),(0,$.jsxs)(`radialGradient`,{id:`meterBlue-${i}`,cx:`50%`,cy:`55%`,r:`72%`,children:[(0,$.jsx)(`stop`,{offset:`0%`,stopColor:`#5edbff`}),(0,$.jsx)(`stop`,{offset:`42%`,stopColor:`#159fe8`}),(0,$.jsx)(`stop`,{offset:`78%`,stopColor:`#0875c4`}),(0,$.jsx)(`stop`,{offset:`100%`,stopColor:`#043d73`})]}),(0,$.jsxs)(`filter`,{id:`blueGlow-${i}`,x:`-20%`,y:`-30%`,width:`140%`,height:`160%`,children:[(0,$.jsx)(`feGaussianBlur`,{stdDeviation:`9`,result:`blur`}),(0,$.jsx)(`feFlood`,{floodColor:`#38cfff`,floodOpacity:`.72`,result:`glowColor`}),(0,$.jsx)(`feComposite`,{in:`glowColor`,in2:`blur`,operator:`in`,result:`glow`}),(0,$.jsxs)(`feMerge`,{children:[(0,$.jsx)(`feMergeNode`,{in:`glow`}),(0,$.jsx)(`feMergeNode`,{in:`SourceGraphic`})]})]})]}),(0,$.jsx)(`rect`,{x:`0`,y:`0`,width:`1077`,height:`598`,fill:`url(#meterBlue-${i})`,filter:`url(#blueGlow-${i})`}),(0,$.jsx)(`path`,{d:`m537.18074,590.23438 a150.76556 150.76556 0 0 0 -107.3086 45.05078 l214.73829,0 a150.76556 150.76556 0 0 0 -107.42969,-45.05078 z`,fill:`#000`}),(0,$.jsxs)(`g`,{children:[(0,$.jsx)(`path`,{d:`m82,292 45.3061,0`,fill:`none`,stroke:`#000`,strokeWidth:`5`}),(0,$.jsx)(`path`,{d:`m948.30743,285.82189 45.3061,0`,fill:`none`,stroke:`#000`,strokeWidth:`5`}),(0,$.jsx)(`path`,{d:`m970.96048,263.16884 0,45.3061`,fill:`none`,stroke:`#000`,strokeWidth:`5`}),(0,$.jsx)(`path`,{d:`m657,277.24518 c85.60879,8.87328 173.21481,25.29511 295.97922,75.9692`,fill:`none`,stroke:`#f00`,strokeWidth:`15`}),(0,$.jsx)(`path`,{d:`m126.01626,357.7731 c161.49448,-60.14366 315.01211,-98.096 531.2366,-81.4418`,fill:`none`,stroke:`#000`,strokeWidth:`15`}),(0,$.jsx)(`path`,{d:`m210.72277,271.30126 34.37058 47.77511`,fill:`none`,stroke:`#000`,strokeWidth:`8`}),(0,$.jsx)(`path`,{d:`m285.65064,249.6478 27.49646 52.24328`,fill:`none`,stroke:`#000`,strokeWidth:`8`}),(0,$.jsx)(`path`,{d:`m365.73409,233.49363 18.56011 52.93069`,fill:`none`,stroke:`#000`,strokeWidth:`8`}),(0,$.jsx)(`path`,{d:`m451.66054,221.12022 8.93635 53.96181`,fill:`none`,stroke:`#000`,strokeWidth:`8`}),(0,$.jsx)(`path`,{d:`m544.1174,217.33945 -0.68741 53.96181`,fill:`none`,stroke:`#000`,strokeWidth:`8`}),(0,$.jsx)(`path`,{d:`m620.76379,220.0891 -8.59264 53.2744`,fill:`none`,stroke:`#000`,strokeWidth:`8`}),(0,$.jsx)(`path`,{d:`m669.22631,226.96322 -14.43565 56.36775`,fill:`none`,stroke:`#f00`,strokeWidth:`8`}),(0,$.jsx)(`path`,{d:`m777.83734,243.8048 -24.40311 48.80622`,fill:`none`,stroke:`#f00`,strokeWidth:`8`}),(0,$.jsx)(`path`,{d:`m864.4512,318.73266 34.37058 -43.65063`,fill:`none`,stroke:`#f00`,strokeWidth:`8`}),(0,$.jsx)(`g`,{transform:`rotate(${r} 537.57412 730.481)`,children:(0,$.jsx)(`path`,{d:`M184.04706,291.70923 537.57412,730.481`,fill:`none`,stroke:`#000`,strokeWidth:`6.7`,strokeLinecap:`butt`})}),(0,$.jsx)(`text`,{x:`492.73926`,y:`393.86093`,fontFamily:`Roboto,Arial,sans-serif`,fontSize:`60`,fontWeight:`900`,children:`VU`}),(0,$.jsx)(`text`,{x:`902.58594`,y:`255.49496`,fontSize:`40`,children:`5`}),(0,$.jsx)(`text`,{x:`775.54688`,y:`218.96762`,fontSize:`40`,children:`3`}),(0,$.jsx)(`text`,{x:`663.13672`,y:`202.96762`,fontSize:`40`,children:`0`}),(0,$.jsx)(`text`,{x:`612.89453`,y:`196.49496`,fontSize:`40`,children:`1`}),(0,$.jsx)(`text`,{x:`530.54688`,y:`194.96762`,fontSize:`40`,children:`3`}),(0,$.jsx)(`text`,{x:`439.58594`,y:`202.49496`,fontSize:`40`,children:`5`}),(0,$.jsx)(`text`,{x:`348.78125`,y:`210.49496`,fontSize:`40`,children:`7`}),(0,$.jsx)(`text`,{x:`251.89453`,y:`221.96762`,fontSize:`40`,children:`10`}),(0,$.jsx)(`text`,{x:`160.42969`,y:`243.96762`,fontSize:`40`,children:`20`})]})]})}function Yl({onClose:e}){let t=(0,_.useRef)(null),n=(0,_.useRef)(null),r=(0,_.useRef)(null),i=(0,_.useRef)(null),a=(0,_.useRef)(null),o=(0,_.useRef)({left:-60,right:-60}),[s,c]=(0,_.useState)(0),[l,u]=(0,_.useState)(!1),[d,f]=(0,_.useState)(.68),[p,m]=(0,_.useState)(!1),[h,g]=(0,_.useState)(0),[v,y]=(0,_.useState)(0),[b,x]=(0,_.useState)(-60),[S,C]=(0,_.useState)(-60),w=Gl[s],T=async()=>{let e=t.current;if(!e)return null;if(r.current)return r.current.state===`suspended`&&await r.current.resume(),r.current;let n=window.AudioContext||window.webkitAudioContext;if(!n)return null;let a=new n,o=a.createMediaElementSource(e),s=a.createChannelSplitter(2),c=a.createAnalyser(),l=a.createAnalyser();return c.fftSize=l.fftSize=1024,c.smoothingTimeConstant=l.smoothingTimeConstant=0,o.connect(s),s.connect(c,0),s.connect(l,1),o.connect(a.destination),r.current=a,i.current={left:c,right:l},a};(0,_.useEffect)(()=>{let e=t.current;if(!e)return;let n=l,r=!1;e.src=w.file,e.volume=d,e.muted=p,e.load(),g(0),y(0),o.current={left:-60,right:-60},x(-60),C(-60);let i=async()=>{if(!r)try{let t=await T();t?.state===`suspended`&&await t.resume(),await e.play(),r||u(!0)}catch{r||u(!1)}};return n?e.readyState>=3?i():e.addEventListener(`canplay`,i,{once:!0}):(e.pause(),u(!1)),()=>{r=!0,e.removeEventListener(`canplay`,i)}},[s]),(0,_.useEffect)(()=>{let e=t.current;e&&(e.volume=d,e.muted=p)},[d,p]),(0,_.useEffect)(()=>{let e=t.current;if(!e)return;let n=()=>g(e.currentTime||0),r=()=>Number.isFinite(e.duration)&&y(e.duration);return e.addEventListener(`timeupdate`,n),e.addEventListener(`loadedmetadata`,r),e.addEventListener(`durationchange`,r),()=>{e.removeEventListener(`timeupdate`,n),e.removeEventListener(`loadedmetadata`,r),e.removeEventListener(`durationchange`,r)}},[s]),(0,_.useEffect)(()=>{let e=n.current;if(!e)return;let t=()=>{let n=e.getContext(`2d`);n.clearRect(0,0,e.width,e.height);let s=i.current,c=performance.now();if(s){let i=new Uint8Array(s.left.frequencyBinCount),a=new Uint8Array(s.right.frequencyBinCount),u=new Uint8Array(s.left.fftSize),d=new Uint8Array(s.right.fftSize);s.left.getByteTimeDomainData(u),s.right.getByteTimeDomainData(d);let f=e=>{let t=0;for(let n=0;n<e.length;n++){let r=(e[n]-128)/128;t+=r*r}return Math.sqrt(t/e.length)},p=e=>e<=1e-6?-60:Kl(20*Math.log10(e),-60,0),m=e=>Kl(e+12,-30,10),h=m(p(f(u))),g=m(p(f(d))),_=(e,t,n)=>{let r=t>e?.045:.32;return e+(t-e)*(1-Math.exp(-n/(r*1e3)))},v=Kl(c-(t.lastTime||c),1,80);t.lastTime=c;let y=_(o.current.left,h,v),b=_(o.current.right,g,v);o.current={left:y,right:b},x(y),C(b),s.left.getByteFrequencyData(i),s.right.getByteFrequencyData(a);let S=Math.min(16e3,(r.current?.sampleRate||44100)/2),w=S/i.length,T=Math.log(30),E=Math.log(S),D=(e.width-16-126)/64;for(let t=0;t<64;t++){let r=Math.exp(T+(E-T)*(t/64)),o=Math.exp(T+(E-T)*((t+1)/64)),s=Math.max(0,Math.floor(r/w)),c=Math.min(i.length-1,Math.max(s,Math.ceil(o/w))),u=0,d=0;for(let e=s;e<=c;e++){let t=(i[e]+a[e])/510;u+=t,d++}let f=(d?u/d:0)**.62,p=Math.max(2,e.height*f*(l?.9:.08)),m=8+t*(D+2);n.fillStyle=`rgba(100,190,255,.75)`,n.fillRect(m,e.height-p,D,p)}}else o.current={left:-60,right:-60},x(-60),C(-60);a.current=requestAnimationFrame(t)};return t(),()=>cancelAnimationFrame(a.current)},[l]);let E=async()=>{let e=t.current;if(e)try{let t=await T();t?.state===`suspended`&&await t.resume(),await e.play(),u(!0)}catch{u(!1)}},D=()=>{l?(t.current?.pause(),u(!1)):E()},O=e=>c(t=>(t+e+Gl.length)%Gl.length);return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`style`,{children:`
        @keyframes loriPulse {
      ...
      `}),(0,$.jsx)(`div`,{className:`tracks-overlay`,onPointerDown:t=>t.pointerType===`mouse`&&e(),children:(0,$.jsxs)(`div`,{className:`tracks-window`,onPointerDown:e=>e.stopPropagation(),onClick:e=>e.stopPropagation(),children:[(0,$.jsx)(`audio`,{ref:t,onEnded:()=>O(1)}),(0,$.jsx)(`button`,{className:`tracks-close`,onClick:e,children:`×`}),(0,$.jsxs)(`div`,{className:`tracks-brand`,children:[(0,$.jsx)(`span`,{children:`NYXTRYP`}),(0,$.jsx)(`span`,{className:`tracks-brand-pulse`,children:`TRACK`})]}),(0,$.jsxs)(`div`,{className:`nyx-vu`,children:[(0,$.jsx)(`div`,{className:`nyx-meter`,children:(0,$.jsx)(Jl,{channel:`L`,value:b})}),(0,$.jsx)(`div`,{className:`nyx-meter`,children:(0,$.jsx)(Jl,{channel:`R`,value:S})})]}),(0,$.jsx)(`canvas`,{ref:n,className:`tracks-visualizer`,width:1200,height:240}),(0,$.jsxs)(`div`,{className:`tracks-controls`,children:[(0,$.jsx)(`button`,{className:`tracks-button`,onClick:()=>O(-1),children:`‹`}),(0,$.jsx)(`button`,{className:`tracks-button main`,onClick:D,children:l?`Ⅱ`:`▶`}),(0,$.jsx)(`button`,{className:`tracks-button`,onClick:()=>O(1),children:`›`})]}),(0,$.jsxs)(`div`,{className:`tracks-progress`,children:[(0,$.jsx)(`span`,{children:ql(h)}),(0,$.jsx)(`input`,{type:`range`,min:`0`,max:v||0,step:`.1`,value:Math.min(h,v||0),onChange:e=>{let n=Number(e.target.value);t.current&&(t.current.currentTime=n),g(n)}}),(0,$.jsx)(`span`,{children:ql(v)})]}),(0,$.jsxs)(`div`,{className:`tracks-volume`,children:[(0,$.jsx)(`button`,{className:`tracks-button`,onClick:()=>m(e=>!e),children:p?`🔇`:`🔊`}),(0,$.jsx)(`input`,{type:`range`,min:`0`,max:`1`,step:`.01`,value:d,onChange:e=>f(Number(e.target.value))})]}),(0,$.jsx)(`div`,{className:`tracks-playlist`,children:Gl.map((e,t)=>(0,$.jsxs)(`button`,{className:`tracks-item${t===s?` active`:``}`,onClick:()=>{c(t),setTimeout(E,100)},children:[(0,$.jsx)(`span`,{className:`tracks-number`,children:String(t+1).padStart(2,`0`)}),(0,$.jsx)(`span`,{className:`tracks-item-title`,children:e.title})]},e.file))})]})})]})}function Xl(){let[e,t]=(0,_.useState)(!1),[n,r]=(0,_.useState)(!1),[i,a]=(0,_.useState)(!1),[o,s]=(0,_.useState)(!1);return(0,$.jsx)(`div`,{className:`scene`,children:e?(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(Il,{}),(0,$.jsx)(Rl,{onRadioOpen:()=>r(!0),onMixesOpen:()=>a(!0),onTracksOpen:()=>s(!0)}),n&&(0,$.jsx)(`div`,{onPointerDown:e=>{e.pointerType===`mouse`&&r(!1)},style:{position:`fixed`,inset:0,zIndex:100,display:`flex`,alignItems:`center`,justifyContent:`center`,background:`rgba(0,0,0,.10)`,backdropFilter:`blur(2px)`,cursor:`default`},children:(0,$.jsx)(`div`,{onClick:e=>e.stopPropagation(),onPointerDown:e=>e.stopPropagation(),style:{position:`relative`,zIndex:101},children:(0,$.jsx)(Vl,{onClose:()=>r(!1)})})}),o&&(0,$.jsx)(`div`,{onPointerDown:e=>{e.pointerType===`mouse`&&s(!1)},style:{position:`fixed`,inset:0,zIndex:100,display:`flex`,alignItems:`center`,justifyContent:`center`,background:`rgba(0,0,0,.10)`,backdropFilter:`blur(2px)`,cursor:`default`},children:(0,$.jsx)(`div`,{onClick:e=>e.stopPropagation(),onPointerDown:e=>e.stopPropagation(),style:{position:`relative`,zIndex:101},children:(0,$.jsx)(Yl,{onClose:()=>s(!1)})})}),i&&(0,$.jsx)(`div`,{onPointerDown:e=>{e.pointerType===`mouse`&&a(!1)},style:{position:`fixed`,inset:0,zIndex:100,display:`flex`,alignItems:`center`,justifyContent:`center`,background:`rgba(0,0,0,.10)`,backdropFilter:`blur(2px)`,cursor:`default`},children:(0,$.jsx)(`div`,{onClick:e=>e.stopPropagation(),onPointerDown:e=>e.stopPropagation(),style:{position:`relative`,zIndex:101},children:(0,$.jsx)(Wl,{onClose:()=>a(!1)})})})]}):(0,$.jsxs)(`section`,{className:`intro`,children:[(0,$.jsx)(`p`,{className:`artist`,children:`NYXTRYP`}),(0,$.jsx)(`h1`,{children:`DON'T LISTEN. ENTER.`}),(0,$.jsx)(`button`,{className:`enter-button`,onClick:()=>t(!0),children:`ENTER`})]})})}function Zl(){return(0,$.jsx)(`main`,{className:`nyxtryp`,children:(0,$.jsx)(Xl,{})})}v.createRoot(document.getElementById(`root`)).render((0,$.jsx)(_.StrictMode,{children:(0,$.jsx)(Zl,{})}));