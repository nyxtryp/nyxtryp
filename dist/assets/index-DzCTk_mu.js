...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function as(e,t,n){let r=new Float32Array(Go),i=new G(0,1,0);return new va({name:`SphericalGaussianBlur`,defines:{n:Go,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:cs(),fragmentShader:`
	...
	`}var ls=class extends mn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Wi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
POINTS: `+i.points+`
WEBGL: `+(n?n.getParameter(n.VERSION):`UNKNOWN`);f.textContent=o;try{localStorage.setItem(`nyxtryp-webgl-diagnostic`,o)}catch(e){console.warn(`NYXTRYP diagnostic localStorage write failed`,e)}};d.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),ge=!0,_=`WEBGL CONTEXT LOST`,cancelAnimationFrame(he),v(`!!! WEBGL CONTEXT LOST !!!`,`The browser/GPU lost the WebGL context.`)},!1),d.addEventListener(`webglcontextrestored`,()=>{ge=!1,_=`WEBGL CONTEXT RESTORED`,v(`WEBGL CONTEXT RESTORED`,`WebGL context was restored by the browser.`),he=requestAnimationFrame(_e)},!1),window.addEventListener(`error`,e=>{_=`window error`,v(`JAVASCRIPT ERROR`,String(e?.message||e?.error||`unknown error`))}),window.addEventListener(`unhandledrejection`,e=>{_=`unhandled promise rejection`,v(`UNHANDLED PROMISE REJECTION`,String(e?.reason||`unknown rejection`))});let y=e=>{_=e};d.addEventListener(`pointerdown`,()=>y(`pointerdown`)),d.addEventListener(`wheel`,()=>y(`wheel / zoom`)),d.style.cursor=`default`,d.style.touchAction=`none`;let b=new co(9546188,.95);a.add(b);let x=new G(-35,18,-55),S=new so(16777215,6.5);S.position.copy(x),S.target.position.set(0,0,-10),S.castShadow=!0,S.shadow.mapSize.width=o?1024:2048,S.shadow.mapSize.height=o?1024:2048,S.shadow.camera.near=1,S.shadow.camera.far=120,a.add(S),a.add(S.target);let C=new Ga(10206463,1120295,.85);a.add(C);let w=new Y(new ca(.75,48,48),new ii({color:16774351,transparent:!0,opacity:0,depthWrite:!1}));w.position.copy(x),a.add(w);let T=new Y(new ca(1.25,48,48),new ii({color:16767370,transparent:!0,opacity:0,depthWrite:!1,blending:2}));T.position.copy(x),a.add(T);let E=[],D=(e,t,n,r,i)=>{let o=new Float32Array(e*3);for(let n=0;n<e;n++)o[n*3]=(Math.random()-.5)*t,o[n*3+1]=(Math.random()-.5)*t,o[n*3+2]=-Math.random()*i;let s=new qr;s.setAttribute(`position`,new Mr(o,3));let c=new Hi(s,new Li({color:16777215,size:n,transparent:!0,opacity:r,depthWrite:!1,sizeAttenuation:!0}));a.add(c),E.push({object:c,speed:15e-5+Math.random()*2e-4})};D(900,100,.035,.45,120),D(420,70,.055,.65,75),D(160,45,.085,.85,45);let O=[];for(let e=0;e<3;e++){let e=new qr;e.setAttribute(`position`,new Mr(new Float32Array([0,0,0,-.9,.25,0]),3));let t=new Fi(e,new Di({color:16777215,transparent:!0,opacity:0}));t.position.set(0,0,-20),a.add(t),O.push({object:t,active:!1,timer:Math.random()*12+5,life:0})}let k=new Ua,A=[];ql.forEach((e,t)=>{let n=k.load(e.texture);n.colorSpace=it,n.anisotropy=c?1:u.capabilities.getMaxAnisotropy();let r=new ba({map:n,roughness:e.atmosphere?.62:.72,metalness:0,envMapIntensity:1.15,emissive:e.atmosphere?new J(16777215):new J(0),emissiveMap:e.atmosphere?n:null,emissiveIntensity:e.atmosphere?.22:0}),o=new Y(new ca(e.radius,64,64),r);o.position.set(...e.position),o.castShadow=!0,o.receiveShadow=!0,o.userData.name=e.name,o.userData.index=t,a.add(o);let s=new io(10470655,2.2,e.radius*13,2);if(s.position.set(-e.radius*2.5,e.radius*1.5,e.radius*3),o.add(s),e.atmosphere){let t=new va({transparent:!0,depthWrite:!1,depthTest:!0,side:1,blending:2,uniforms:{sunDirection:{value:new G(-3,2,5).normalize()},innerRadius:{value:e.radius},outerRadius:{value:e.radius*1.28}},vertexShader:`
      ...
      `}),n=new Y(new ca(e.radius*1.075,c?64:128,c?64:128),t);o.add(n)}if(e.atmosphere){let t=new Gn;t.name=`AUDIO_MENU_SATELLITES_V1`,o.add(t);let n=new Gn;n.name=`TRACKS`;let r=new Y(new ca(e.radius*.2,32,32),new ba({color:1381146,metalness:.72,roughness:.28,emissive:2365195,emissiveIntensity:.45}));n.add(r);let i=new Y(new ca(e.radius*.42,16,16),new ii({transparent:!0,opacity:0,depthWrite:!1}));i.userData.isTracksHitArea=!0,n.add(i);let a=new Y(new la(e.radius*.3,e.radius*.018,12,64),new ii({color:16761917,transparent:!0,opacity:.95}));a.rotation.x=Math.PI*.48,n.add(a);for(let t=0;t<4;t++){let r=new Y(new Ji(e.radius*.3,e.radius*.014,e.radius*.018),new ii({color:16767078,transparent:!0,opacity:.8}));r.position.set(-e.radius*.05,(t-1.5)*e.radius*.065,e.radius*.2),r.rotation.z=(t-1.5)*.07,n.add(r)}n.position.set(-e.radius*2,0,0),t.add(n);let s=new Gn;s.name=`MIXES`;let c=new Y(new ca(e.radius*.22,32,32),new ba({color:7421388,metalness:.55,roughness:.24,emissive:3412062,emissiveIntensity:.8}));s.add(c);let l=new ii({color:13671167,transparent:!0,opacity:.9}),u=new ii({color:9395455,transparent:!0,opacity:.8}),d=new Y(new la(e.radius*.34,e.radius*.015,12,64),l);d.rotation.x=Math.PI*.42,d.rotation.z=Math.PI*.18,s.add(d);let f=new Y(new la(e.radius*.34,e.radius*.013,12,64),u);f.rotation.x=-Math.PI*.42,f.rotation.z=-Math.PI*.22,s.add(f);for(let t=0;t<3;t++){let n=new Y(new ca(e.radius*.035,16,16),new ii({color:15187455})),r=t*Math.PI*2/3;n.position.set(Math.cos(r)*e.radius*.4,Math.sin(r)*e.radius*.25,Math.sin(r)*e.radius*.4),s.add(n)}s.position.set(e.radius*2,.15,0),t.add(s);let p=new Gn;p.name=`RADIO`;let m=new Y(new ca(e.radius*.21,32,32),new ba({color:2330328,metalness:.48,roughness:.22,emissive:411765,emissiveIntensity:.8}));p.add(m);let h=new Y(new ca(e.radius*.55,16,16),new ii({transparent:!0,opacity:0,depthWrite:!1}));h.name=`RADIO_HITBOX`,p.add(h);let g=new Y(new Yi(e.radius*.014,e.radius*.022,e.radius*.45,12),new ba({color:12115967,metalness:.8,roughness:.18}));g.position.y=e.radius*.32,p.add(g);let _=new Y(new ca(e.radius*.17,24,12,0,Math.PI*2,0,Math.PI*.5),new ba({color:10214655,metalness:.72,roughness:.18,emissive:1204368,emissiveIntensity:.55,side:2}));_.position.y=e.radius*.54,_.rotation.x=-Math.PI*.25,p.add(_);let v=new ii({color:5626367,transparent:!0,opacity:.48});for(let t=0;t<3;t++){let n=new Y(new la(e.radius*(.28+t*.12),e.radius*.012,8,48,Math.PI),v);n.position.set(e.radius*(.16+t*.04),e.radius*(.68+t*.06),0),n.rotation.z=-Math.PI*.5,p.add(n)}p.position.set(0,e.radius*2,-e.radius*.1),t.add(p),t.userData.menuPositions={TRACKS:new G(-e.radius*2,0,0),MIXES:new G(0,e.radius*2,0),RADIO:new G(e.radius*2,0,0)},t.userData.menuRotations={TRACKS:new Dn(0,0,0),MIXES:new Dn(0,0,0),RADIO:new Dn(0,0,0)},t.userData.freePositions={TRACKS:n.position.clone(),MIXES:s.position.clone(),RADIO:p.position.clone()},o.userData.audioSatellites=t}if(e.name===`VIDEOS`){let t=new Gn;t.name=`VIDEOS_SATELLITES`;let n=new Gn;n.name=`YOUTUBE`;let r=new Y(new ca(e.radius*.3,32,32),new ba({color:1381653,metalness:.65,roughness:.25,emissive:3145728,emissiveIntensity:.55}));n.add(r);let i=new Y(new la(e.radius*.42,e.radius*.018,10,48),new ii({color:16724016,transparent:!0,opacity:.9}));i.rotation.x=Math.PI*.43,i.rotation.z=Math.PI*.18,n.add(i),n.scale.set(1.8,1.8,1.8),n.position.set(e.radius*2,0,0),t.add(n),t.userData.youtube=n,t.userData.freePosition=n.position.clone(),t.userData.orbitRadius=e.radius*2,t.userData.orbitAngle=0,t.userData.inverseQuaternion=new Jt,t.userData.targetPosition=new G,t.userData.worldPosition=new G,o.add(t),o.userData.videosSatellites=t}let l={mesh:o,speed:e.speed,base:o.position.clone(),driftX:.1+Math.random()*.16,driftY:.08+Math.random()*.14,driftZ:.06+Math.random()*.12,ampX:.35+Math.random()*.35,ampY:.25+Math.random()*.3,ampZ:.2+Math.random()*.3,phaseX:Math.random()*Math.PI*2,phaseY:Math.random()*Math.PI*2,phaseZ:Math.random()*Math.PI*2,selectionOffset:new G};A.push(l);let d=document.createElement(`div`);if(d.className=`planet-name`,d.textContent=e.name,d.style.position=`absolute`,d.style.color=`#ffffff`,d.style.fontSize=`8px`,d.style.letterSpacing=`0.28em`,d.style.fontFamily=`Arial, Helvetica, sans-serif`,d.style.pointerEvents=`none`,d.style.whiteSpace=`nowrap`,d.style.transform=`translate(-50%, -50%)`,d.style.opacity=`0.8`,d.style.zIndex=`20`,i.appendChild(d),l.nameLabel=d,e.rings){let t=k.load(`/textures/planets/saturn-ring.png`);t.colorSpace=it;let n=new Y(new sa(e.radius*1.25,e.radius*2.05,96),new ba({map:t,transparent:!0,side:2,depthWrite:!1,roughness:.85}));n.rotation.x=Math.PI/2.25,n.rotation.z=.15,o.add(n)}});let ee={};[`TRACKS`,`MIXES`,`RADIO`].forEach(e=>{let t=document.createElement(`div`);t.style.position=`absolute`,t.style.left=`0`,t.style.top=`0`,t.style.transform=`translate(-50%, -50%)`,t.style.color=`#ffffff`,t.style.fontSize=`9px`,t.style.fontFamily=`Arial, Helvetica, sans-serif`,t.style.fontWeight=`400`,t.style.letterSpacing=`0.32em`,t.style.textTransform=`uppercase`,t.style.whiteSpace=`nowrap`,t.style.pointerEvents=`none`,t.style.opacity=`0`,t.style.transition=`opacity 0.25s ease`,t.style.zIndex=`21`,t.textContent=e,i.appendChild(t),ee[e]=t});let j=document.createElement(`div`);j.style.position=`absolute`,j.style.left=`0`,j.style.top=`0`,j.style.transform=`translate(-50%, -50%)`,j.style.color=`#ffffff`,j.style.fontSize=`9px`,j.style.fontFamily=`Arial, Helvetica, sans-serif`,j.style.fontWeight=`400`,j.style.letterSpacing=`0.32em`,j.style.whiteSpace=`nowrap`,j.style.pointerEvents=`none`,j.style.opacity=`0`,j.style.transition=`opacity 0.25s ease`,j.style.zIndex=`21`,j.textContent=`YOUTUBE`,i.appendChild(j);let te=new Do,ne=new W,re=null,M=null,N=!1,P=!1,ie=0,ae=0,oe=17,se=new G(0,0,17),F=new G(0,0,0),I=e=>{let t=d.getBoundingClientRect();ne.x=(e.clientX-t.left)/t.width*2-1,ne.y=-((e.clientY-t.top)/t.height*2-1)},ce=e=>{I(e),te.setFromCamera(ne,l);let t=A.map(({mesh:e})=>e),n=[];for(let{mesh:e}of A)e.userData.name===`VIDEOS`&&e.userData.videosSatellites&&e.userData.videosSatellites.traverse(e=>{e.isMesh&&e.visible&&n.push(e)}),e.userData.name===`AUDIO`&&e.userData.audioSatellites&&e.userData.audioSatellites.traverse(e=>{e.isMesh&&e.visible&&n.push(e)});let r=te.intersectObjects(t,!1),i=te.intersectObjects(n,!1);return i.length?i[0].object:r.length?r[0].object:null},le=!1,ue=!1,de=e=>{let t=ce(e);if(t&&!P?(re=t,d.style.cursor=`pointer`):P||(re=null,d.style.cursor=`default`),!P)return;let n=e.clientX-ie,r=e.clientY-ae;(Math.abs(n)>2||Math.abs(r)>2)&&(le=!0),ie=e.clientX,ae=e.clientY,M&&(M.rotation.y+=n*.01,M.rotation.x+=r*.005,M.rotation.x=qt.clamp(M.rotation.x,-Math.PI*.45,Math.PI*.45))},fe=r=>{if(r.pointerType===`mouse`&&r.button!==0)return;let o=ce(r);if(!o){P=!1;return}if(o.userData.name===`RELEASES`){let e=document.getElementById(`nyxtryp-releases-window`);e&&e.remove();let t=document.createElement(`div`);t.id=`nyxtryp-releases-window`,t.style.position=`absolute`,t.style.inset=`0`,t.style.zIndex=`100`,t.style.background=`rgba(0,0,0,0.94)`,t.style.display=`flex`,t.style.alignItems=`center`,t.style.justifyContent=`center`,t.style.overflow=`hidden`,t.style.fontFamily=`Arial, Helvetica, sans-serif`;let n=document.createElement(`button`);n.textContent=`×`,n.style.position=`absolute`,n.style.right=`24px`,n.style.top=`18px`,n.style.zIndex=`5`,n.style.border=`0`,n.style.background=`transparent`,n.style.color=`#ffffff`,n.style.fontSize=`30px`,n.style.fontWeight=`200`,n.style.cursor=`pointer`,n.style.opacity=`0.75`,n.onclick=()=>t.remove(),t.appendChild(n);let r=document.createElement(`div`);r.style.position=`relative`,r.style.width=`min(900px, 86vw)`,r.style.height=`min(650px, 78vh)`,r.style.display=`flex`,r.style.flexDirection=`column`,r.style.alignItems=`center`,r.style.justifyContent=`center`,r.style.overflow=`hidden`,t.appendChild(r);let i=document.createElement(`div`);i.textContent=`RELEASES`,i.style.color=`#ffffff`,i.style.fontSize=`clamp(32px, 6vw, 72px)`,i.style.fontWeight=`300`,i.style.letterSpacing=`0.18em`,i.style.textAlign=`center`,i.style.marginBottom=`32px`,r.appendChild(i);let a=document.createElement(`div`);a.textContent=`No releases yet.
New music is coming.`,a.style.color=`rgba(255,255,255,0.72)`,a.style.fontSize=`clamp(15px, 2vw, 19px)`,a.style.fontWeight=`300`,a.style.letterSpacing=`0.08em`,a.style.lineHeight=`1.8`,a.style.textAlign=`center`,a.style.whiteSpace=`pre-line`,r.appendChild(a),document.body.appendChild(t);return}let s=null,c=o;for(;c;){if(c.name===`YOUTUBE`){s=c;break}c=c.parent}if(s){if(!(M&&M.userData.name===`VIDEOS`&&oe<10)){P=!1,le=!1,ue=!1;return}window.open(`https://www.youtube.com/@nyxtryp`,`_blank`,`noopener,noreferrer`),P=!1,le=!1,ue=!1;return}let f=null;for(c=o;c;){if(c.name===`RADIO`){f=c;break}c=c.parent}if(f){N&&M&&M.userData.name===`AUDIO`&&e&&e(),P=!1,le=!1,ue=!1;return}let p=null;for(c=o;c;){if(c.name===`TRACKS`){p=c;break}c=c.parent}if(p){N&&M&&M.userData.name===`AUDIO`&&n&&n(),P=!1,le=!1,ue=!1;return}let m=null;for(c=o;c;){if(c.name===`MIXES`){m=c;break}c=c.parent}if(m){N&&M&&M.userData.name===`AUDIO`&&t&&t(),P=!1,le=!1,ue=!1;return}if(o.userData.name===`VISUALS`){y(`VISUALS cinematic flight opened`);let e=document.getElementById(`nyxtryp-visuals-window`);e&&e.remove();let t=document.createElement(`div`);t.id=`nyxtryp-visuals-window`,Object.assign(t.style,{position:`fixed`,inset:`0`,zIndex:`100000`,background:`transparent`,pointerEvents:`none`,overflow:`hidden`});let n=document.createElement(`button`);n.textContent=`×`,Object.assign(n.style,{position:`absolute`,top:`22px`,right:`28px`,zIndex:`20`,background:`transparent`,border:`0`,color:`rgba(255,255,255,.72)`,fontSize:`28px`,fontWeight:`200`,cursor:`pointer`,pointerEvents:`auto`,lineHeight:`1`,padding:`8px`,fontFamily:`Arial, Helvetica, sans-serif`}),t.appendChild(n),document.body.appendChild(t);let r=l.position.clone(),i=l.quaternion.clone(),o=se.clone(),s=F.clone(),c=M,d=oe,f=u.getPixelRatio(),p=!0,m=!1,h=performance.now();new G,new G,new G;let g=[];document.querySelectorAll(`.planet-name`).forEach(e=>{g.push({label:e,opacity:e.style.opacity}),e.style.opacity=`0`}),Object.values(ee).forEach(e=>{g.push({label:e,opacity:e.style.opacity}),e.style.opacity=`0`}),j.style.opacity=`0`;let _=e=>{let t=A.find(t=>t.mesh&&t.mesh.userData&&t.mesh.userData.name===e);return t?t.mesh:null},v=e=>{let t=new G;return e.getWorldPosition(t),t},b=(e,t)=>{let n=_(e);if(!n)return null;let r=v(n),i=r.clone().sub(l.position).normalize();return r.clone().sub(i.multiplyScalar(t))},x=new Gn;x.name=`NYXTRYP_VISUALS_METEORS`,a.add(x);let S=new aa(.08,1),C=new ba({color:7829367,roughness:.92,metalness:.05}),w=[];for(let e=0;e<90;e++){let e=new Y(S,C);e.position.set(qt.randFloatSpread(34),qt.randFloatSpread(22),qt.randFloat(-8,-70));let t=qt.randFloat(.35,3.2);e.scale.setScalar(t),e.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI),e.userData.velocity=new G(qt.randFloat(-.035,.035),qt.randFloat(-.035,.035),qt.randFloat(.1,.38)),e.userData.spin=new G(qt.randFloat(-.025,.025),qt.randFloat(-.025,.025),qt.randFloat(-.025,.025)),x.add(e),w.push(e)}let T=[];[`TRACKS`,`MIXES`,`RADIO`,`YOUTUBE`].forEach((e,t)=>{let n=a.getObjectByName(e);if(!n)return;let r=n.clone(!0),i=v(n);r.position.copy(i),r.quaternion.copy(n.getWorldQuaternion(new Jt)),r.scale.multiplyScalar(1.15),r.userData.cinematic=!0,r.userData.index=t,a.add(r),T.push(r)});let E=[`AUDIO`,`VIDEOS`,`PHOTOS`,`RELEASES`,`GUESTBOOK`,`ABOUT`,`SOCIAL`],D=[];D.push(l.position.clone()),E.forEach(e=>{let t=b(e,qt.randFloat(2.4,4.8));t&&D.push(t)}),D.push(new G(0,1.5,-31));let O=new ia(D,!1,`catmullrom`,.48),k=l.position.clone(),te=new G,ne=l.position.clone(),re=0,N=performance.now(),P=document.createElement(`div`);Object.assign(P.style,{position:`absolute`,inset:`0`,background:`#000`,opacity:`0`,pointerEvents:`none`,transition:`opacity 1.8s ease`,zIndex:`5`}),t.appendChild(P);let ie=document.createElement(`div`);Object.assign(ie.style,{position:`absolute`,inset:`0`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,opacity:`0`,transition:`opacity 2.5s ease`,color:`#fff`,fontFamily:`Arial, Helvetica, sans-serif`,pointerEvents:`none`,zIndex:`10`});let ae=document.createElement(`div`);ae.textContent=`NYXTRYP`,Object.assign(ae.style,{fontSize:`clamp(38px, 7vw, 86px)`,fontWeight:`200`,letterSpacing:`0.42em`,marginLeft:`0.42em`,textShadow:`0 0 35px rgba(180,220,255,.35)`});let I=document.createElement(`div`);I.textContent=`SEE YOU`,Object.assign(I.style,{marginTop:`18px`,fontSize:`11px`,fontWeight:`300`,letterSpacing:`0.65em`,marginLeft:`0.65em`,opacity:`0.62`}),ie.appendChild(ae),ie.appendChild(I),t.appendChild(ie);let ce={x:0,y:0,targetX:0,targetY:0},le=e=>{let t=e.clientX??(e.touches&&e.touches[0]&&e.touches[0].clientX),n=e.clientY??(e.touches&&e.touches[0]&&e.touches[0].clientY);t!=null&&n!=null&&(ce.targetX=(t/window.innerWidth-.5)*2,ce.targetY=(n/window.innerHeight-.5)*2)};window.addEventListener(`pointermove`,le);let ue=e=>{if(!p)return;let t=e-h,n=Math.min(1,t/6e4),r=Math.min(.05,(e-N)/1e3);N=e;let i;if(n<.1){let e=n/.1;i=e*e*.12}else i=n<.78?.12+(n-.1)/.68*.68:.8+(n-.78)/.22*.2;let o=O.getPointAt(qt.clamp(i,0,1)),s=O.getTangentAt(qt.clamp(i,0,.999));ce.x+=(ce.targetX-ce.x)*Math.min(1,r*2.8),ce.y+=(ce.targetY-ce.y)*Math.min(1,r*2.8),k.lerp(o,Math.min(1,r*5.5));let c=new G().crossVectors(s,l.up).normalize(),d=new G().crossVectors(c,s).normalize();k.addScaledVector(c,ce.x*1.35),k.addScaledVector(d,-ce.y*.95),l.position.copy(k),te.copy(k),te.addScaledVector(s,5.5);let f=Math.sin(t*42e-5)*.018+ce.x*.025;l.lookAt(te),l.rotateZ(f);let g=1+n*2.8;if(w.forEach((e,t)=>{let n=e.userData.velocity;e.position.x+=n.x*g,e.position.y+=n.y*g,e.position.z+=n.z*g,e.rotation.x+=e.userData.spin.x,e.rotation.y+=e.userData.spin.y,e.rotation.z+=e.userData.spin.z;let r=e.position.clone().sub(l.position);(r.length()>75||r.z>12)&&(e.position.copy(l.position),e.position.addScaledVector(s,qt.randFloat(-45,-18)),e.position.addScaledVector(c,qt.randFloat(-16,16)),e.position.addScaledVector(d,qt.randFloat(-12,12)))}),T.forEach((e,n)=>{let i=t*(25e-5+n*35e-6);e.position.add(new G(Math.sin(i*1.7+n)*r*2.2,Math.cos(i*1.3+n)*r*1.6,Math.sin(i*.9+n)*r*3.8)),e.rotation.y+=r*(.35+n*.11),e.position.clone().sub(l.position).length()>55&&(e.position.copy(l.position),e.position.addScaledVector(s,qt.randFloat(-18,6)),e.position.addScaledVector(c,qt.randFloat(-10,10)),e.position.addScaledVector(d,qt.randFloat(-8,8)))}),n>.84){let e=(n-.84)/.16;P.style.opacity=String(Math.min(.92,e*1.25))}n>=1&&!m&&(m=!0,P.style.opacity=`1`,setTimeout(()=>{ie.style.opacity=`1`},1500)),u.render(a,l),ne.copy(l.position),re=requestAnimationFrame(ue)},de=()=>{p&&(p=!1,cancelAnimationFrame(re),window.removeEventListener(`pointermove`,le),x.removeFromParent(),T.forEach(e=>{e.removeFromParent()}),S.dispose(),C.dispose(),l.position.copy(r),l.quaternion.copy(i),se.copy(o),F.copy(s),oe=d,M=c,u.setPixelRatio(f),g.forEach(({label:e,opacity:t})=>{e.style.opacity=t}),j.style.opacity=`0`,t.remove(),u.render(a,l))};n.addEventListener(`click`,de);let fe=e=>{e.key===`Escape`&&(de(),window.removeEventListener(`keydown`,fe))};window.addEventListener(`keydown`,fe),requestAnimationFrame(ue);return}if(o.userData.name===`GUESTBOOK`){y(`GUESTBOOK opened`);let e=document.getElementById(`nyxtryp-guestbook-window`);e&&e.remove();let t=document.createElement(`style`);t.id=`nyxtryp-guestbook-style`,t.textContent=`
...
Оставайся в движении.`:c,d()},a.appendChild(s),requestAnimationFrame(()=>{setTimeout(()=>{o.style.top=`8%`,o.style.transform=`translateY(0)`,o.style.fontSize=`clamp(24px, 4vw, 48px)`,o.style.letterSpacing=`0.22em`,setTimeout(()=>{d()},700)},150)}),t.onclick=e=>{e.target===t&&t.remove()},i.appendChild(t),P=!1,le=!1,ue=!1;return}if(M===o){ue=!0,le=!1,P=!0,ie=r.clientX,ae=r.clientY,d.style.cursor=`grabbing`;return}ue=!1,le=!1,M=o,N=o.userData.name===`AUDIO`,oe=qt.clamp(o.geometry.parameters.radius*7,4.5,8),P=!0,ie=r.clientX,ae=r.clientY,d.style.cursor=`grabbing`},pe=()=>{P=!1,ue&&!le&&(M=null,N=!1,oe=17),ue=!1,le=!1,re?d.style.cursor=`pointer`:d.style.cursor=`default`},me=e=>{e.preventDefault(),M&&(oe+=e.deltaY*.012,oe=qt.clamp(oe,Math.max(1.8,M.geometry.parameters.radius*2.2),17))};d.addEventListener(`pointermove`,de),d.addEventListener(`pointerdown`,fe),d.addEventListener(`pointerup`,pe),d.addEventListener(`pointercancel`,pe),d.addEventListener(`wheel`,me,{passive:!1});let he,ge=!1,_e=()=>{if(!ge)try{let e=performance.now()*.001;p+=1;let t=performance.now(),n=t-h;h=t,n>0&&(g=Math.round(1e3/n)),p%60==0&&f&&v(`WEBGL RUNNING`,`No context loss detected yet.`),A.forEach(t=>{let{mesh:n,speed:r,base:i,driftX:a,driftY:o,driftZ:s,ampX:c,ampY:u,ampZ:f,phaseX:p,phaseY:m,phaseZ:h}=t;if(t.nameLabel){let e=new G;n.getWorldPosition(e),e.y+=n.geometry.parameters.radius*1.6,e.project(l);let r=d.getBoundingClientRect();t.nameLabel.style.left=(e.x+1)/2*r.width+`px`,t.nameLabel.style.top=(-e.y+1)/2*r.height+`px`;let i=n.position.clone().sub(l.position).normalize(),a=new Do(l.position,i),o=A.filter(e=>e.mesh!==n).map(e=>e.mesh),s=a.intersectObjects(o,!1);t.nameLabel.style.opacity=s.length?`0`:`0.8`}n!==M&&(n.userData.name===`VIDEOS`?n.rotation.y-=r:n.rotation.y+=r);let g=n.userData.videosSatellites;if(g){let e=g.userData.youtube,i=g.userData.orbitRadius,a=n===M&&oe<10;if(a){let t=g.userData.inverseQuaternion;t.copy(n.quaternion).invert();let r=g.userData.targetPosition;r.set(-i,0,0).applyQuaternion(t),e.position.lerp(r,.08)}else{e.rotation.y-=r*2,g.userData.orbitAngle-=r*6;let t=g.userData.orbitAngle;e.position.set(Math.cos(t)*i,0,Math.sin(t)*i)}let o=g.userData.worldPosition;e.getWorldPosition(o),o.y+=n.geometry.parameters.radius*.65,o.project(l);let s=d.getBoundingClientRect();j.style.left=(o.x+1)/2*s.width+`px`,j.style.top=(-o.y+1)/2*s.height+`px`,j.style.opacity=a?`0.8`:`0`,a&&t.nameLabel&&(t.nameLabel.style.opacity=`0.8`),a&&t.nameLabel&&(t.nameLabel.style.opacity=`0.8`)}let _=n.userData.audioSatellites;if(_){let e=_.userData.menuPositions,t=_.userData.freePositions;if(e&&t){let r=N&&n===M,i=n.quaternion.clone().invert(),a={TRACKS:e.TRACKS.clone(),MIXES:e.MIXES.clone(),RADIO:e.RADIO.clone()},o={TRACKS:a.TRACKS.applyQuaternion(i),MIXES:a.MIXES.applyQuaternion(i),RADIO:a.RADIO.applyQuaternion(i)},s={TRACKS:r?o.TRACKS:t.TRACKS,MIXES:r?o.MIXES:t.MIXES,RADIO:r?o.RADIO:t.RADIO},c=_.userData.menuRotations,l=_.getObjectByName(`TRACKS`),u=_.getObjectByName(`MIXES`),d=_.getObjectByName(`RADIO`);l&&(l.position.lerp(s.TRACKS,.08),r&&l.quaternion.slerp(new Jt().setFromEuler(c.TRACKS).premultiply(i),.08)),u&&(u.position.lerp(s.MIXES,.08),r&&u.quaternion.slerp(new Jt().setFromEuler(c.MIXES).premultiply(i),.08)),d&&(d.position.lerp(s.RADIO,.08),r&&d.quaternion.slerp(new Jt().setFromEuler(c.RADIO).premultiply(i),.08))}}let v=i.x+Math.sin(e*a+p)*c,y=i.y+Math.sin(e*o+m)*u,b=i.z+Math.sin(e*s+h)*f,x=new G(0,0,l.position.z-oe),S=new G(v,y,b),C=n===M?x.sub(S):new G;t.selectionOffset.lerp(C,.045),n.position.set(v+t.selectionOffset.x,y+t.selectionOffset.y,b+t.selectionOffset.z)}),se.lerp(new G(0,0,window.innerWidth<768?28:17),.05),F.lerp(new G(0,0,0),.05),l.position.copy(se),l.lookAt(F),[`TRACKS`,`MIXES`,`RADIO`].forEach(e=>{let t=ee[e];if(!t)return;let n=(M?.userData?.audioSatellites)?.getObjectByName(e);if(N&&n){let e=n.getWorldPosition(new G);e.y+=M.geometry.parameters.radius*.48;let r=e.project(l),i=d.getBoundingClientRect();t.style.left=`${(r.x+1)*.5*i.width}px`,t.style.top=`${(-r.y+1)*.5*i.height}px`,t.style.opacity=`1`}else t.style.opacity=`0`}),E.forEach(({object:e,speed:t},n)=>{e.rotation.y+=t*(n+1),e.rotation.x+=t*.35});let r=1+Math.sin(e*.45)*.025;w.scale.setScalar(r),T.scale.setScalar(1+Math.sin(e*.45)*.05),O.forEach(e=>{e.active?(e.life+=.016,e.object.position.x-=.22,e.object.position.y-=.08,e.object.material.opacity=Math.max(0,1-e.life/.8),e.life>.8&&(e.active=!1,e.timer=8+Math.random()*18)):(e.timer-=.016,e.timer<=0&&(e.active=!0,e.life=0,e.object.position.set((Math.random()-.5)*24,6+Math.random()*8,-10-Math.random()*30),e.object.material.opacity=1))}),u.render(a,l),he=requestAnimationFrame(_e)}catch(e){_=`ANIMATE LOOP CRASH`,v(`!!! ANIMATION LOOP CRASH !!!`,String(e?.stack||e?.message||e)),console.error(`NYXTRYP ANIMATE LOOP CRASH:`,e);return}},ve=()=>{let e=i.clientWidth,t=i.clientHeight;l.aspect=e/t,l.updateProjectionMatrix(),u.setSize(e,t)};return ve(),window.addEventListener(`resize`,ve),_e(),()=>{cancelAnimationFrame(he),window.removeEventListener(`resize`,ve),d.removeEventListener(`pointermove`,de),d.removeEventListener(`pointerdown`,fe),d.removeEventListener(`pointerup`,pe),d.removeEventListener(`pointercancel`,pe),d.removeEventListener(`wheel`,me),A.forEach(({mesh:e})=>{e.geometry.dispose(),e.material.map?.dispose(),e.material.dispose()}),E.forEach(({object:e})=>{e.geometry.dispose(),e.material.dispose()}),O.forEach(({object:e})=>{e.geometry.dispose(),e.material.dispose()}),Object.values(ee).forEach(e=>{e.remove()}),document.querySelectorAll(`.planet-name`).forEach(e=>{e.remove()}),u.dispose(),i.contains(u.domElement)&&i.removeChild(u.domElement)}},[]),(0,x.jsx)(`div`,{ref:r,className:`planet-field`})}var Yl=[{title:`Amazing Nature`,file:`/audio/radio/Amazing_Nature.mp3`},{title:`Calm Vibrations`,file:`/audio/radio/Calm_Vibrations.mp3`},{title:`Deep Sleep`,file:`/audio/radio/Deep_Sleep.mp3`},{title:`Forest Before Rain`,file:`/audio/radio/Forest_Before_Rain.mp3`},{title:`Forest Sounds`,file:`/audio/radio/Forest_Sounds.mp3`},{title:`Harmony`,file:`/audio/radio/Harmony.mp3`},{title:`Inner Peace`,file:`/audio/radio/Inner_Peace.mp3`},{title:`Inside Japan`,file:`/audio/radio/Inside_Japan.mp3`},{title:`Iren Lullaby`,file:`/audio/radio/Iren_Lullaby.mp3`},{title:`Morning Prayer`,file:`/audio/radio/Morning_Prayer.mp3`},{title:`Ocean Waves`,file:`/audio/radio/Ocean_Waves.mp3`},{title:`Path to Happiness`,file:`/audio/radio/Path_to_Happiness.mp3`},{title:`Quiet Place`,file:`/audio/radio/Quiet_Place.mp3`},{title:`Sparks`,file:`/audio/radio/Sparks.mp3`},{title:`Thunderstorm`,file:`/audio/radio/Thunderstorm.mp3`}];function Xl(e=-1){if(Yl.length<=1)return 0;let t=Math.floor(Math.random()*Yl.length);for(;t===e;)t=Math.floor(Math.random()*Yl.length);return t}function Zl({onClose:e}){if(!document.getElementById(`lori-animation`)){let e=document.createElement(`style`);e.id=`lori-animation`,e.innerHTML=`
    ...
    `}),(0,x.jsx)(`div`,{className:`tracks-overlay`,onPointerDown:t=>t.pointerType===`mouse`&&e(),children:(0,x.jsxs)(`div`,{className:`tracks-window`,onPointerDown:e=>e.stopPropagation(),onClick:e=>e.stopPropagation(),children:[(0,x.jsx)(`audio`,{ref:t,onEnded:()=>j(1)}),(0,x.jsx)(`button`,{className:`tracks-close`,onClick:e,children:`×`}),(0,x.jsxs)(`div`,{className:`tracks-brand`,children:[(0,x.jsx)(`span`,{children:`NYXTRYP`}),(0,x.jsx)(`span`,{className:`tracks-brand-pulse`,children:`TRACK`})]}),(0,x.jsxs)(`div`,{className:`nyx-vu`,children:[(0,x.jsx)(`div`,{className:`nyx-meter`,children:(0,x.jsx)(iu,{channel:`L`,value:C})}),(0,x.jsx)(`div`,{className:`nyx-meter`,children:(0,x.jsx)(iu,{channel:`R`,value:T})})]}),(0,x.jsx)(`canvas`,{ref:n,className:`tracks-visualizer`,width:`1200`,height:`240`}),(0,x.jsxs)(`div`,{className:`tracks-controls`,children:[(0,x.jsx)(`button`,{className:`tracks-button`,onClick:()=>j(-1),children:`‹`}),(0,x.jsx)(`button`,{className:`tracks-button main`,onClick:ee,children:d?`Ⅱ`:`▶`}),(0,x.jsx)(`button`,{className:`tracks-button`,onClick:()=>j(1),children:`›`})]}),(0,x.jsxs)(`div`,{className:`tracks-progress`,children:[(0,x.jsx)(`span`,{children:ru(_)}),(0,x.jsx)(`input`,{type:`range`,min:`0`,max:y||0,step:`.1`,value:Math.min(_,y||0),onChange:e=>{let n=Number(e.target.value);t.current&&(t.current.currentTime=n),v(n)}}),(0,x.jsx)(`span`,{children:ru(y)})]}),(0,x.jsxs)(`div`,{className:`tracks-volume`,children:[(0,x.jsx)(`button`,{className:`tracks-button`,onClick:()=>g(e=>!e),children:h?`🔇`:`🔊`}),(0,x.jsx)(`input`,{type:`range`,min:`0`,max:`1`,step:`.01`,value:p,onChange:e=>m(Number(e.target.value))})]}),(0,x.jsx)(`div`,{className:`tracks-playlist`,children:tu.map((e,t)=>(0,x.jsxs)(`button`,{className:`tracks-item${t===l?` active`:``}`,onClick:()=>{u(t),setTimeout(A,100)},children:[(0,x.jsx)(`span`,{className:`tracks-number`,children:String(t+1).padStart(2,`0`)}),(0,x.jsx)(`span`,{className:`tracks-item-title`,children:e.title})]},e.file))})]})})]})}function ou(){let[e,t]=(0,b.useState)(!1),[n,r]=(0,b.useState)(!1),[i,a]=(0,b.useState)(!1),[o,s]=(0,b.useState)(!1);return(0,x.jsx)(`div`,{className:`scene`,children:e?(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(S,{}),(0,x.jsx)(Jl,{onRadioOpen:()=>r(!0),onMixesOpen:()=>a(!0),onTracksOpen:()=>s(!0)}),n&&(0,x.jsx)(`div`,{onPointerDown:e=>{e.pointerType===`mouse`&&r(!1)},style:{position:`fixed`,inset:0,zIndex:100,display:`flex`,alignItems:`center`,justifyContent:`center`,background:`rgba(0,0,0,.10)`,backdropFilter:`blur(2px)`,cursor:`default`},children:(0,x.jsx)(`div`,{onClick:e=>e.stopPropagation(),onPointerDown:e=>e.stopPropagation(),style:{position:`relative`,zIndex:101},children:(0,x.jsx)(Zl,{onClose:()=>r(!1)})})}),o&&(0,x.jsx)(`div`,{onPointerDown:e=>{e.pointerType===`mouse`&&s(!1)},style:{position:`fixed`,inset:0,zIndex:100,display:`flex`,alignItems:`center`,justifyContent:`center`,background:`rgba(0,0,0,.10)`,backdropFilter:`blur(2px)`,cursor:`default`},children:(0,x.jsx)(`div`,{onClick:e=>e.stopPropagation(),onPointerDown:e=>e.stopPropagation(),style:{position:`relative`,zIndex:101},children:(0,x.jsx)(au,{onClose:()=>s(!1)})})}),i&&(0,x.jsx)(`div`,{onPointerDown:e=>{e.pointerType===`mouse`&&a(!1)},style:{position:`fixed`,inset:0,zIndex:100,display:`flex`,alignItems:`center`,justifyContent:`center`,background:`rgba(0,0,0,.10)`,backdropFilter:`blur(2px)`,cursor:`default`},children:(0,x.jsx)(`div`,{onClick:e=>e.stopPropagation(),onPointerDown:e=>e.stopPropagation(),style:{position:`relative`,zIndex:101},children:(0,x.jsx)(eu,{onClose:()=>a(!1)})})})]}):(0,x.jsxs)(`section`,{className:`intro`,children:[(0,x.jsx)(`p`,{className:`artist`,children:`NYXTRYP`}),(0,x.jsx)(`h1`,{children:`DON'T LISTEN. ENTER.`}),(0,x.jsx)(`button`,{className:`enter-button`,onClick:()=>t(!0),children:`ENTER`})]})})}var su=[{id:`tracks`,label:`TRACKS`,accept:`audio/mpeg,audio/mp3`,icon:`♪`,kind:`AUDIO`},{id:`radio`,label:`RADIO`,accept:`audio/mpeg,audio/mp3`,icon:`◉`,kind:`AUDIO`},{id:`mixes`,label:`MIXES`,accept:`audio/mpeg,audio/mp3`,icon:`◒`,kind:`AUDIO`},{id:`photos`,label:`PHOTOS`,accept:`image/*`,icon:`▧`,kind:`IMAGE`}],cu=e=>e.replace(/\.[^.]+$/,``),lu=e=>(e.match(/\.[^.]+$/)||[``])[0];async function uu(e){if(!e)throw Error(`Файл не выбран`);let t;try{t=await e.arrayBuffer()}catch(n){try{t=await new Promise((t,r)=>{let i=new FileReader;i.onload=()=>t(i.result),i.onerror=()=>r(i.error||n),i.onabort=()=>r(Error(`Чтение файла отменено`)),i.readAsArrayBuffer(e)})}catch(e){throw Error(`Не удалось прочитать файл: ${e?.message||n?.message||`ошибка доступа`}`)}}let n=new Uint8Array(t),r=``,i=32768;for(let e=0;e<n.length;e+=i)r+=String.fromCharCode(...n.subarray(e,Math.min(e+i,n.length)));return btoa(r)}async function du(e){let t=2936012.8;if(e.size<=t)return{file:e,name:e.name};let n=null,r=null;try{`createImageBitmap`in window?n=await createImageBitmap(e):(r=URL.createObjectURL(e),n=await new Promise((t,n)=>{let i=new Image,a=setTimeout(()=>n(Error(`Изображение слишком долго готовится`)),8e3);i.onload=()=>{clearTimeout(a),t(i)},i.onerror=()=>{clearTimeout(a),n(Error(`Не удалось прочитать изображение «${e.name}»`))},i.src=r}));let i=n.width||n.naturalWidth,a=n.height||n.naturalHeight;if(!i||!a)throw Error(`Не удалось определить размер изображения «${e.name}»`);let o=Math.min(1,2400/Math.max(i,a)),s=Math.max(1,Math.round(i*o)),c=Math.max(1,Math.round(a*o)),l=document.createElement(`canvas`);l.width=s,l.height=c;let u=l.getContext(`2d`);if(!u)throw Error(`Не удалось подготовить изображение`);u.drawImage(n,0,0,s,c),n.close&&n.close(),r&&URL.revokeObjectURL(r),r=null;let d=e=>new Promise((t,n)=>{l.toBlob(e=>e?t(e):n(Error(`Не удалось сжать изображение`)),`image/jpeg`,e)}),f=.88,p=await d(f);for(;p.size>t&&f>.55;)f-=.07,p=await d(f);if(p.size>t)throw Error(`«${e.name}» не удалось уменьшить до допустимого размера`);let m=cu(e.name).trim()||`photo`;return{file:new File([p],`${m}.jpg`,{type:`image/jpeg`}),name:`${m}.jpg`}}catch(e){throw n?.close&&n.close(),r&&URL.revokeObjectURL(r),e}}function fu(e,t){return(lu(e).replace(`.`,``)||(t===`photos`?`image`:`audio`)).toUpperCase()}function pu(){let[e,t]=(0,b.useState)(()=>sessionStorage.getItem(`nyxtryp-admin-key`)||``),[n,r]=(0,b.useState)(!1),[i,a]=(0,b.useState)(`tracks`),[o,s]=(0,b.useState)({tracks:[],radio:[],mixes:[],photos:[]}),[c,l]=(0,b.useState)(!1),[u,d]=(0,b.useState)(``),[f,p]=(0,b.useState)(``),[m,h]=(0,b.useState)(null),[g,_]=(0,b.useState)(null),[v,y]=(0,b.useState)(null),[S,C]=(0,b.useState)(``),[w,T]=(0,b.useState)(`name`),[E,D]=(0,b.useState)(null),[O,k]=(0,b.useState)(null),[A,ee]=(0,b.useState)({}),j=(0,b.useRef)(null),te=(0,b.useMemo)(()=>su.find(e=>e.id===i),[i]),ne=async()=>{try{let e=await fetch(`/api/admin`,{cache:`no-store`}),t=await e.json();if(!e.ok)throw Error(t.error||`Не удалось загрузить список`);s(t),r(!0),p(``)}catch(e){r(!1),p(e.message||`Ошибка подключения`)}};(0,b.useEffect)(()=>{let e=sessionStorage.getItem(`nyxtryp-admin-key`);e&&(async()=>{try{if(!(await fetch(`/api/admin`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({action:`auth`,adminKey:e})})).ok)throw Error(`Неверный admin key`);await ne()}catch{sessionStorage.removeItem(`nyxtryp-admin-key`),t(``),r(!1)}})()},[]);let re=async(t,n)=>{let r=await fetch(`/api/admin`,{method:t,headers:{"Content-Type":`application/json`},body:JSON.stringify({...n,adminKey:e})}),i=await r.json().catch(()=>({}));if(!r.ok)throw Error(i.error||`Ошибка ${r.status}`);return i},M=async t=>{if(t.preventDefault(),e.trim()){d(`ПРОВЕРКА…`),p(``);try{await re(`POST`,{action:`auth`}),sessionStorage.setItem(`nyxtryp-admin-key`,e.trim()),await ne(),d(``)}catch(e){r(!1),p(e.message||`Неверный admin key`),d(``)}}},N=()=>{sessionStorage.removeItem(`nyxtryp-admin-key`),t(``),r(!1)},P=e=>{y(e||null),d(`ВЫБЕРИТЕ ФАЙЛ…`),p(``),h(null),j.current&&(j.current.value=``),requestAnimationFrame(()=>j.current?.click())},ie=async e=>{let t=e.currentTarget,n=Array.from(t.files||[]);if(!n.length){d(`ФАЙЛ НЕ ВЫБРАН`);return}if(i!==`photos`){let e=n.find(e=>e.size>4194304);if(e){p(`«${e.name}» больше 4 МБ. Большие MP3 пока нельзя передать через текущий Vercel API.`),d(`ОШИБКА ПРОВЕРКИ`);return}}l(!0),p(``),h({total:n.length,current:0,step:`prepare`,name:n[0].name}),d(`1/4 · ЧТЕНИЕ ФАЙЛА`);let r;try{r=await Promise.all(n.map(async e=>{try{let t=await e.arrayBuffer();return{original:e,file:new File([t],e.name,{type:e.type||`application/octet-stream`,lastModified:e.lastModified||Date.now()})}}catch(t){throw Error(`Не удалось получить доступ к файлу «${e.name}»: ${t?.message||`ошибка чтения`}`)}}))}catch(e){p(e.message||`Ошибка чтения файла`),d(`ОШИБКА ЗАГРУЗКИ`),l(!1),t.value=``;return}d(`1/4 · ПОДГОТОВКА`);try{for(let e=0;e<r.length;e+=1){let t=r[e].file;h({total:n.length,current:e+1,step:`prepare`,name:t.name}),d(`${e+1}/${n.length} · ПОДГОТОВКА`);let a=i===`photos`?await du(t):{file:t,name:t.name},o=a.file,s=v||a.name;h({total:n.length,current:e+1,step:`encode`,name:s}),d(`${e+1}/${n.length} · ЧТЕНИЕ ФАЙЛА`);let c=await uu(o);h({total:n.length,current:e+1,step:`send`,name:s}),d(`${e+1}/${n.length} · ОТПРАВКА В GITHUB`),await re(`POST`,{type:i,name:s,content:c}),h({total:n.length,current:e+1,step:`done`,name:s}),d(`${e+1}/${n.length} · СОХРАНЕНО`)}y(null),h({total:n.length,current:n.length,step:`done`,name:n[n.length-1].name}),await ne(),d(n.length>1?`ГОТОВО · СОХРАНЕНО ${n.length}`:`ГОТОВО · ФАЙЛ СОХРАНЁН`)}catch(e){p(e.message||`Ошибка сохранения`),d(`ОШИБКА ЗАГРУЗКИ`)}finally{l(!1),t.value=``}},ae=async e=>{D(null),l(!0),p(``),d(`УДАЛЕНИЕ…`);try{await re(`DELETE`,{type:i,name:e}),await ne(),d(`УДАЛЕНО`)}catch(e){p(e.message||`Ошибка удаления`),d(``)}finally{l(!1)}},oe=async()=>{if(g?.newName.trim()){l(!0),p(``),d(`ПЕРЕИМЕНОВАНИЕ…`);try{await re(`PATCH`,{type:i,oldName:g.oldName,newName:`${g.newName.trim()}${lu(g.oldName)}`}),_(null),await ne(),d(`ИМЯ ИЗМЕНЕНО`)}catch(e){p(e.message||`Ошибка переименования`),d(``)}finally{l(!1)}}},se=(0,b.useMemo)(()=>{let e=o[i]||[];return[...S.trim()?e.filter(e=>e.toLowerCase().includes(S.trim().toLowerCase())):e].sort((e,t)=>w===`name`?e.localeCompare(t,void 0,{numeric:!0,sensitivity:`base`}):w===`type`?fu(e,i).localeCompare(fu(t,i))||e.localeCompare(t):0)},[o,i,S,w]);if((0,b.useEffect)(()=>{if(i!==`photos`)return;let e={};(o.photos||[]).forEach(t=>{e[t]=`/photos/${encodeURIComponent(t)}`}),ee(e)},[i,o.photos]),!n)return(0,x.jsxs)(`div`,{className:`nyx-admin-shell`,children:[(0,x.jsx)(`style`,{children:mu}),(0,x.jsxs)(`form`,{className:`nyx-admin-login`,onSubmit:M,children:[(0,x.jsx)(`div`,{className:`brand-mark`,children:`NYX`}),(0,x.jsx)(`div`,{className:`kicker`,children:`NYXTRYP / PRIVATE`}),(0,x.jsx)(`h1`,{children:`MEDIA CONTROL`}),(0,x.jsx)(`div`,{className:`sub`,children:`ADMIN ACCESS`}),(0,x.jsx)(`input`,{autoFocus:!0,type:`password`,value:e,onChange:e=>t(e.target.value),placeholder:`Admin key`}),(0,x.jsx)(`button`,{disabled:c,children:c?`CHECKING…`:`ENTER`}),u&&(0,x.jsx)(`p`,{className:`status`,children:u}),f&&(0,x.jsx)(`p`,{className:`err`,children:f})]})]});let F=o[i]?.length||0,I=m?.step||``;return(0,x.jsxs)(`div`,{className:`nyx-admin-shell`,children:[(0,x.jsx)(`style`,{children:mu}),(0,x.jsxs)(`main`,{className:`nyx-admin-panel`,children:[(0,x.jsxs)(`header`,{className:`topbar`,children:[(0,x.jsxs)(`div`,{className:`brand-block`,children:[(0,x.jsx)(`div`,{className:`brand-mark`,children:`NYX`}),(0,x.jsxs)(`div`,{children:[(0,x.jsx)(`div`,{className:`kicker`,children:`NYXTRYP / PRIVATE`}),(0,x.jsx)(`h1`,{children:`MEDIA CONTROL`}),(0,x.jsx)(`p`,{children:`CONTENT MANAGEMENT`})]})]}),(0,x.jsxs)(`button`,{className:`plain exit`,disabled:c,onClick:N,children:[`EXIT `,(0,x.jsx)(`span`,{children:`↗`})]})]}),(0,x.jsxs)(`section`,{className:`overview`,children:[(0,x.jsxs)(`div`,{children:[(0,x.jsx)(`div`,{className:`section-label`,children:`MEDIA LIBRARY`}),(0,x.jsxs)(`div`,{className:`headline`,children:[`YOUR UNIVERSE, `,(0,x.jsx)(`span`,{children:`ORGANIZED.`})]})]}),(0,x.jsxs)(`div`,{className:`total`,children:[(0,x.jsx)(`strong`,{children:Object.values(o).reduce((e,t)=>e+(t?.length||0),0)}),(0,x.jsx)(`span`,{children:`TOTAL FILES`})]})]}),(0,x.jsx)(`nav`,{className:`tabs`,children:su.map(e=>(0,x.jsxs)(`button`,{className:i===e.id?`active`:``,onClick:()=>{a(e.id),d(``),p(``),h(null),C(``),T(`name`)},children:[(0,x.jsx)(`i`,{children:e.icon}),(0,x.jsx)(`span`,{children:e.label}),(0,x.jsx)(`b`,{children:o[e.id]?.length||0})]},e.id))}),(0,x.jsxs)(`section`,{className:`toolbar`,children:[(0,x.jsxs)(`button`,{className:`add`,disabled:c,onClick:()=>P(null),children:[(0,x.jsx)(`span`,{children:`＋`}),i===`photos`?`UPLOAD PHOTOS`:`ADD ${te.label.slice(0,-1)}`]}),(0,x.jsxs)(`div`,{className:`search`,children:[(0,x.jsx)(`span`,{children:`⌕`}),(0,x.jsx)(`input`,{value:S,onChange:e=>C(e.target.value),placeholder:`SEARCH ${te.label.toLowerCase()}…`}),S&&(0,x.jsx)(`button`,{onClick:()=>C(``),children:`×`})]}),(0,x.jsxs)(`select`,{value:w,onChange:e=>T(e.target.value),"aria-label":`Sort files`,children:[(0,x.jsx)(`option`,{value:`name`,children:`NAME`}),(0,x.jsx)(`option`,{value:`type`,children:`TYPE`})]})]}),(0,x.jsx)(`input`,{ref:j,className:`upload-input`,id:`nyx-media-upload`,type:`file`,accept:te.accept,multiple:i===`photos`,onChange:ie}),m&&(0,x.jsxs)(`section`,{className:`upload-progress`,children:[(0,x.jsxs)(`div`,{className:`progress-head`,children:[(0,x.jsxs)(`div`,{children:[(0,x.jsx)(`div`,{className:`kicker`,children:`UPLOAD PROCESS`}),(0,x.jsx)(`strong`,{children:m.name})]}),(0,x.jsx)(`span`,{children:m.total>1?`${m.current}/${m.total}`:I.toUpperCase()})]}),(0,x.jsxs)(`div`,{className:`progress-steps`,children:[(0,x.jsxs)(`div`,{className:[`prepare`,`encode`,`send`,`done`].indexOf(I)>=0?`done`:``,children:[(0,x.jsx)(`b`,{children:`1`}),(0,x.jsx)(`span`,{children:`PREPARE`})]}),(0,x.jsx)(`i`,{}),(0,x.jsxs)(`div`,{className:[`encode`,`send`,`done`].indexOf(I)>=0?`done`:``,children:[(0,x.jsx)(`b`,{children:`2`}),(0,x.jsx)(`span`,{children:`READ`})]}),(0,x.jsx)(`i`,{}),(0,x.jsxs)(`div`,{className:[`send`,`done`].indexOf(I)>=0?`done`:``,children:[(0,x.jsx)(`b`,{children:`3`}),(0,x.jsx)(`span`,{children:`SEND`})]}),(0,x.jsx)(`i`,{}),(0,x.jsxs)(`div`,{className:I===`done`?`done`:``,children:[(0,x.jsx)(`b`,{children:`4`}),(0,x.jsx)(`span`,{children:`DONE`})]})]}),u&&(0,x.jsx)(`div`,{className:`progress-status`,children:u}),f&&(0,x.jsx)(`div`,{className:`progress-error`,children:f})]}),(0,x.jsx)(`section`,{className:`media-grid`,children:se.map(e=>(0,x.jsxs)(`article`,{className:`media-card`,children:[i===`photos`?(0,x.jsx)(`button`,{className:`thumb`,onClick:()=>k(A[e]),children:(0,x.jsx)(`img`,{src:A[e],alt:e})}):(0,x.jsx)(`div`,{className:`audio-icon`,children:te.icon}),(0,x.jsxs)(`div`,{className:`media-info`,children:[(0,x.jsx)(`strong`,{title:e,children:e}),(0,x.jsxs)(`span`,{children:[fu(e,i),` · `,F,` TOTAL`]})]}),(0,x.jsxs)(`div`,{className:`media-actions`,children:[(0,x.jsx)(`button`,{className:`plain`,disabled:c,onClick:()=>_({oldName:e,newName:cu(e)}),children:`RENAME`}),(0,x.jsx)(`button`,{className:`danger`,disabled:c,onClick:()=>D(e),children:`DELETE`}),i!==`photos`&&(0,x.jsx)(`button`,{className:`plain`,disabled:c,onClick:()=>P(e),children:`REPLACE`})]})]},e))}),se.length===0&&(0,x.jsx)(`div`,{className:`empty`,children:`NO FILES FOUND`}),g&&(0,x.jsx)(`div`,{className:`modal-backdrop`,children:(0,x.jsxs)(`form`,{className:`modal`,onSubmit:e=>{e.preventDefault(),oe()},children:[(0,x.jsx)(`div`,{className:`kicker`,children:`EDIT MEDIA`}),(0,x.jsx)(`h2`,{children:`RENAME FILE`}),(0,x.jsx)(`input`,{autoFocus:!0,value:g.newName,onChange:e=>_({...g,newName:e.target.value})}),(0,x.jsxs)(`div`,{className:`modal-actions`,children:[(0,x.jsx)(`button`,{type:`button`,className:`plain`,onClick:()=>_(null),children:`CANCEL`}),(0,x.jsx)(`button`,{type:`submit`,disabled:c,children:`SAVE`})]})]})}),E&&(0,x.jsx)(`div`,{className:`modal-backdrop`,children:(0,x.jsxs)(`div`,{className:`modal`,children:[(0,x.jsx)(`div`,{className:`kicker`,children:`DANGER ZONE`}),(0,x.jsx)(`h2`,{children:`DELETE FILE?`}),(0,x.jsx)(`p`,{children:E}),(0,x.jsxs)(`div`,{className:`modal-actions`,children:[(0,x.jsx)(`button`,{className:`plain`,onClick:()=>D(null),children:`CANCEL`}),(0,x.jsx)(`button`,{className:`danger`,disabled:c,onClick:()=>ae(E),children:`DELETE`})]})]})}),O&&(0,x.jsx)(`div`,{className:`modal-backdrop photo-modal`,onClick:()=>k(null),children:(0,x.jsx)(`img`,{src:O,alt:`Preview`})}),(0,x.jsxs)(`footer`,{children:[(0,x.jsxs)(`span`,{children:[F,` FILES`]}),(0,x.jsx)(`span`,{children:`GITHUB STORAGE`}),(0,x.jsx)(`span`,{children:`VIA NYXTRYP ADMIN`})]})]})]})}var mu=`
...
`;function hu(){return window.location.pathname===`/admin`?(0,x.jsx)(pu,{}):(0,x.jsx)(`main`,{className:`nyxtryp`,children:(0,x.jsx)(ou,{})})}y.createRoot(document.getElementById(`root`)).render((0,x.jsx)(b.StrictMode,{children:(0,x.jsx)(hu,{})}));