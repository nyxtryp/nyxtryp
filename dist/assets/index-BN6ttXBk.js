...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `}),n=new mi(new Xi(e.radius*1.075,128,128),t);o.add(n)}if(e.atmosphere){let t=new Un;t.name=`AUDIO_MENU_SATELLITES_V1`,o.add(t);let n=new Un;n.name=`TRACKS`;let r=new mi(new Xi(e.radius*.2,32,32),new ca({color:1381146,metalness:.72,roughness:.28,emissive:2365195,emissiveIntensity:.45}));n.add(r);let i=new mi(new Zi(e.radius*.3,e.radius*.018,12,64),new ni({color:16761917,transparent:!0,opacity:.95}));i.rotation.x=Math.PI*.48,n.add(i);for(let t=0;t<4;t++){let r=new mi(new Ki(e.radius*.3,e.radius*.014,e.radius*.018),new ni({color:16767078,transparent:!0,opacity:.8}));r.position.set(-e.radius*.05,(t-1.5)*e.radius*.065,e.radius*.2),r.rotation.z=(t-1.5)*.07,n.add(r)}n.position.set(-e.radius*2,0,0),t.add(n);let a=new Un;a.name=`MIXES`;let s=new mi(new Xi(e.radius*.22,32,32),new ca({color:7421388,metalness:.55,roughness:.24,emissive:3412062,emissiveIntensity:.8}));a.add(s);let c=new ni({color:13671167,transparent:!0,opacity:.9}),l=new ni({color:9395455,transparent:!0,opacity:.8}),u=new mi(new Zi(e.radius*.34,e.radius*.015,12,64),c);u.rotation.x=Math.PI*.42,u.rotation.z=Math.PI*.18,a.add(u);let d=new mi(new Zi(e.radius*.34,e.radius*.013,12,64),l);d.rotation.x=-Math.PI*.42,d.rotation.z=-Math.PI*.22,a.add(d);for(let t=0;t<3;t++){let n=new mi(new Xi(e.radius*.035,16,16),new ni({color:15187455})),r=t*Math.PI*2/3;n.position.set(Math.cos(r)*e.radius*.4,Math.sin(r)*e.radius*.25,Math.sin(r)*e.radius*.4),a.add(n)}a.position.set(e.radius*2,.15,0),t.add(a);let f=new Un;f.name=`RADIO`;let p=new mi(new Xi(e.radius*.21,32,32),new ca({color:2330328,metalness:.48,roughness:.22,emissive:411765,emissiveIntensity:.8}));f.add(p);let m=new mi(new Xi(e.radius*.55,16,16),new ni({transparent:!0,opacity:0,depthWrite:!1}));m.name=`RADIO_HITBOX`,f.add(m);let h=new mi(new qi(e.radius*.014,e.radius*.022,e.radius*.45,12),new ca({color:12115967,metalness:.8,roughness:.18}));h.position.y=e.radius*.32,f.add(h);let g=new mi(new Xi(e.radius*.17,24,12,0,Math.PI*2,0,Math.PI*.5),new ca({color:10214655,metalness:.72,roughness:.18,emissive:1204368,emissiveIntensity:.55,side:2}));g.position.y=e.radius*.54,g.rotation.x=-Math.PI*.25,f.add(g);let _=new ni({color:5626367,transparent:!0,opacity:.48});for(let t=0;t<3;t++){let n=new mi(new Zi(e.radius*(.28+t*.12),e.radius*.012,8,48,Math.PI),_);n.position.set(e.radius*(.16+t*.04),e.radius*(.68+t*.06),0),n.rotation.z=-Math.PI*.5,f.add(n)}f.position.set(0,e.radius*2,-e.radius*.1),t.add(f),t.userData.menuPositions={TRACKS:new W(-e.radius*2,0,0),MIXES:new W(0,e.radius*2,0),RADIO:new W(e.radius*2,0,0)},t.userData.menuRotations={TRACKS:new Tn(0,0,0),MIXES:new Tn(0,0,0),RADIO:new Tn(0,0,0)},t.userData.freePositions={TRACKS:n.position.clone(),MIXES:a.position.clone(),RADIO:f.position.clone()},o.userData.audioSatellites=t}let l={mesh:o,speed:e.speed,base:o.position.clone(),driftX:.1+Math.random()*.16,driftY:.08+Math.random()*.14,driftZ:.06+Math.random()*.12,ampX:.35+Math.random()*.35,ampY:.25+Math.random()*.3,ampZ:.2+Math.random()*.3,phaseX:Math.random()*Math.PI*2,phaseY:Math.random()*Math.PI*2,phaseZ:Math.random()*Math.PI*2,selectionOffset:new W};y.push(l);let u=document.createElement(`div`);if(u.className=`planet-name`,u.textContent=e.name,u.style.position=`absolute`,u.style.color=`#ffffff`,u.style.fontSize=`8px`,u.style.letterSpacing=`0.28em`,u.style.fontFamily=`Arial, Helvetica, sans-serif`,u.style.pointerEvents=`none`,u.style.whiteSpace=`nowrap`,u.style.transform=`translate(-50%, -50%)`,u.style.opacity=`0.8`,u.style.zIndex=`20`,r.appendChild(u),l.nameLabel=u,e.rings){let t=v.load(`/textures/planets/saturn-ring.png`);t.colorSpace=tt;let n=new mi(new Yi(e.radius*1.25,e.radius*2.05,96),new ca({map:t,transparent:!0,side:2,depthWrite:!1,roughness:.85}));n.rotation.x=Math.PI/2.25,n.rotation.z=.15,o.add(n)}});let b={};[`TRACKS`,`MIXES`,`RADIO`].forEach(e=>{let t=document.createElement(`div`);t.style.position=`absolute`,t.style.left=`0`,t.style.top=`0`,t.style.transform=`translate(-50%, -50%)`,t.style.color=`#ffffff`,t.style.fontSize=`9px`,t.style.fontFamily=`Arial, Helvetica, sans-serif`,t.style.fontWeight=`400`,t.style.letterSpacing=`0.32em`,t.style.textTransform=`uppercase`,t.style.whiteSpace=`nowrap`,t.style.pointerEvents=`none`,t.style.opacity=`0`,t.style.transition=`opacity 0.25s ease`,t.style.zIndex=`21`,t.textContent=e,r.appendChild(t),b[e]=t});let x=new ho,S=new U,C=null,w=null,T=!1,E=!1,D=0,O=0,k=17,A=new W(0,0,17),j=new W(0,0,0),ee=e=>{let t=c.getBoundingClientRect();S.x=(e.clientX-t.left)/t.width*2-1,S.y=-((e.clientY-t.top)/t.height*2-1)},te=e=>{ee(e),x.setFromCamera(S,o);let t=y.map(({mesh:e})=>e),n=[];for(let{mesh:e}of y)e.userData.name===`AUDIO`&&e.userData.audioSatellites&&e.userData.audioSatellites.traverse(e=>{e.isMesh&&e.visible&&n.push(e)});let r=x.intersectObjects(t,!1),i=x.intersectObjects(n,!1);return i.length&&r.length?i[0].distance<r[0].distance?i[0].object:r[0].object:i.length?i[0].object:r.length?r[0].object:null},ne=!1,re=!1,M=e=>{let t=te(e);if(t&&!E?(C=t,c.style.cursor=`pointer`):E||(C=null,c.style.cursor=`default`),!E)return;let n=e.clientX-D,r=e.clientY-O;(Math.abs(n)>2||Math.abs(r)>2)&&(ne=!0),D=e.clientX,O=e.clientY,w&&(w.rotation.y+=n*.01,w.rotation.x+=r*.005,w.rotation.x=Wt.clamp(w.rotation.x,-Math.PI*.45,Math.PI*.45))},N=n=>{if(n.pointerType===`mouse`&&n.button!==0)return;let r=te(n);if(!r){E=!1;return}let i=null,a=r;for(;a;){if(a.name===`RADIO`){i=a;break}a=a.parent}if(i){T&&w&&w.userData.name===`AUDIO`&&e&&e(),E=!1,ne=!1,re=!1;return}let o=null;for(a=r;a;){if(a.name===`MIXES`){o=a;break}a=a.parent}if(o){T&&w&&w.userData.name===`AUDIO`&&t&&t(),E=!1,ne=!1,re=!1;return}if(w===r){re=!0,ne=!1,E=!0,D=n.clientX,O=n.clientY,c.style.cursor=`grabbing`;return}re=!1,ne=!1,w=r,T=r.userData.name===`AUDIO`,k=Wt.clamp(r.geometry.parameters.radius*7,4.5,8),E=!0,D=n.clientX,O=n.clientY,c.style.cursor=`grabbing`},ie=()=>{E=!1,re&&!ne&&(w=null,T=!1,k=17),re=!1,ne=!1,C?c.style.cursor=`pointer`:c.style.cursor=`default`},ae=e=>{e.preventDefault(),w&&(k+=e.deltaY*.012,k=Wt.clamp(k,Math.max(1.8,w.geometry.parameters.radius*2.2),17))};c.addEventListener(`pointermove`,M),c.addEventListener(`pointerdown`,N),c.addEventListener(`pointerup`,ie),c.addEventListener(`pointercancel`,ie),c.addEventListener(`wheel`,ae,{passive:!1});let oe,P=()=>{let e=performance.now()*.001;y.forEach(t=>{let{mesh:n,speed:r,base:i,driftX:a,driftY:s,driftZ:l,ampX:u,ampY:d,ampZ:f,phaseX:p,phaseY:m,phaseZ:h}=t;if(t.nameLabel){let e=new W;n.getWorldPosition(e),e.y+=n.geometry.parameters.radius*1.6,e.project(o);let r=c.getBoundingClientRect();t.nameLabel.style.left=(e.x+1)/2*r.width+`px`,t.nameLabel.style.top=(-e.y+1)/2*r.height+`px`;let i=n.position.clone().sub(o.position).normalize(),a=new ho(o.position,i),s=y.filter(e=>e.mesh!==n).map(e=>e.mesh),l=a.intersectObjects(s,!1);t.nameLabel.style.opacity=l.length?`0`:`0.8`}n!==w&&(n.rotation.y+=r);let g=n.userData.audioSatellites;if(g){let e=g.userData.menuPositions,t=g.userData.freePositions;if(e&&t){let r=T&&n===w,i=n.quaternion.clone().invert(),a={TRACKS:e.TRACKS.clone(),MIXES:e.MIXES.clone(),RADIO:e.RADIO.clone()},o={TRACKS:a.TRACKS.applyQuaternion(i),MIXES:a.MIXES.applyQuaternion(i),RADIO:a.RADIO.applyQuaternion(i)},s={TRACKS:r?o.TRACKS:t.TRACKS,MIXES:r?o.MIXES:t.MIXES,RADIO:r?o.RADIO:t.RADIO},c=g.userData.menuRotations,l=g.getObjectByName(`TRACKS`),u=g.getObjectByName(`MIXES`),d=g.getObjectByName(`RADIO`);l&&(l.position.lerp(s.TRACKS,.08),r&&l.quaternion.slerp(new Gt().setFromEuler(c.TRACKS).premultiply(i),.08)),u&&(u.position.lerp(s.MIXES,.08),r&&u.quaternion.slerp(new Gt().setFromEuler(c.MIXES).premultiply(i),.08)),d&&(d.position.lerp(s.RADIO,.08),r&&d.quaternion.slerp(new Gt().setFromEuler(c.RADIO).premultiply(i),.08))}}let _=i.x+Math.sin(e*a+p)*u,v=i.y+Math.sin(e*s+m)*d,b=i.z+Math.sin(e*l+h)*f,x=new W(0,0,o.position.z-k),S=new W(_,v,b),C=n===w?x.sub(S):new W;t.selectionOffset.lerp(C,.045),n.position.set(_+t.selectionOffset.x,v+t.selectionOffset.y,b+t.selectionOffset.z)}),A.lerp(new W(0,0,window.innerWidth<768?28:17),.05),j.lerp(new W(0,0,0),.05),o.position.copy(A),o.lookAt(j),[`TRACKS`,`MIXES`,`RADIO`].forEach(e=>{let t=b[e];if(!t)return;let n=(w?.userData?.audioSatellites)?.getObjectByName(e);if(T&&n){let e=n.getWorldPosition(new W);e.y+=w.geometry.parameters.radius*.48;let r=e.project(o),i=c.getBoundingClientRect();t.style.left=`${(r.x+1)*.5*i.width}px`,t.style.top=`${(-r.y+1)*.5*i.height}px`,t.style.opacity=`1`}else t.style.opacity=`0`}),h.forEach(({object:e,speed:t},n)=>{e.rotation.y+=t*(n+1),e.rotation.x+=t*.35});let t=1+Math.sin(e*.45)*.025;p.scale.setScalar(t),m.scale.setScalar(1+Math.sin(e*.45)*.05),_.forEach(e=>{e.active?(e.life+=.016,e.object.position.x-=.22,e.object.position.y-=.08,e.object.material.opacity=Math.max(0,1-e.life/.8),e.life>.8&&(e.active=!1,e.timer=8+Math.random()*18)):(e.timer-=.016,e.timer<=0&&(e.active=!0,e.life=0,e.object.position.set((Math.random()-.5)*24,6+Math.random()*8,-10-Math.random()*30),e.object.material.opacity=1))}),s.render(i,o),oe=requestAnimationFrame(P)},se=()=>{let e=r.clientWidth,t=r.clientHeight;o.aspect=e/t,o.updateProjectionMatrix(),s.setSize(e,t)};return se(),window.addEventListener(`resize`,se),P(),()=>{cancelAnimationFrame(oe),window.removeEventListener(`resize`,se),c.removeEventListener(`pointermove`,M),c.removeEventListener(`pointerdown`,N),c.removeEventListener(`pointerup`,ie),c.removeEventListener(`pointercancel`,ie),c.removeEventListener(`wheel`,ae),y.forEach(({mesh:e})=>{e.geometry.dispose(),e.material.map?.dispose(),e.material.dispose()}),h.forEach(({object:e})=>{e.geometry.dispose(),e.material.dispose()}),_.forEach(({object:e})=>{e.geometry.dispose(),e.material.dispose()}),Object.values(b).forEach(e=>{e.remove()}),document.querySelectorAll(`.planet-name`).forEach(e=>{e.remove()}),s.dispose(),r.contains(s.domElement)&&r.removeChild(s.domElement)}},[]),(0,$.jsx)(`div`,{ref:n,className:`planet-field`})}var zl=[{title:`Amazing Nature`,file:`/audio/radio/Amazing_Nature.mp3`},{title:`Calm Vibrations`,file:`/audio/radio/Calm_Vibrations.mp3`},{title:`Deep Sleep`,file:`/audio/radio/Deep_Sleep.mp3`},{title:`Forest Before Rain`,file:`/audio/radio/Forest_Before_Rain.mp3`},{title:`Forest Sounds`,file:`/audio/radio/Forest_Sounds.mp3`},{title:`Harmony`,file:`/audio/radio/Harmony.mp3`},{title:`Inner Peace`,file:`/audio/radio/Inner_Peace.mp3`},{title:`Inside Japan`,file:`/audio/radio/Inside_Japan.mp3`},{title:`Iren Lullaby`,file:`/audio/radio/Iren_Lullaby.mp3`},{title:`Morning Prayer`,file:`/audio/radio/Morning_Prayer.mp3`},{title:`Ocean Waves`,file:`/audio/radio/Ocean_Waves.mp3`},{title:`Path to Happiness`,file:`/audio/radio/Path_to_Happiness.mp3`},{title:`Quiet Place`,file:`/audio/radio/Quiet_Place.mp3`},{title:`Sparks`,file:`/audio/radio/Sparks.mp3`},{title:`Thunderstorm`,file:`/audio/radio/Thunderstorm.mp3`}];function Bl(e=-1){if(zl.length<=1)return 0;let t=Math.floor(Math.random()*zl.length);for(;t===e;)t=Math.floor(Math.random()*zl.length);return t}function Vl({onClose:e}){if(!document.getElementById(`lori-animation`)){let e=document.createElement(`style`);e.id=`lori-animation`,e.innerHTML=`
      @keyframes loriPulse {
        0%,100% {
          opacity: .45;
